...
import * as strings from 'IhgTimelineWebpartWebPartStrings';
import IhgTimelineWebpart from './components/IhgTimelineWebpart';
import { SPCalendarService } from './SPCalendarService';
import { IIhgTimelineWebpartProps } from './components/IIhgTimelineWebpartProps';
import { ISPListItem } from './ISPList';

export interface IIhgTimelineWebpartWebPartProps {
  query: string;
  icon: string;
  color: string;
...
export default class IhgTimelineWebpartWebPart extends BaseClientSideWebPart<IIhgTimelineWebpartWebPartProps> {
  private guid: string;
