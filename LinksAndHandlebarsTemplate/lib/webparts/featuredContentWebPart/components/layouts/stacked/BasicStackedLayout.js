...
var BasicStackedLayout = (function () {
        ...
        return (React.createElement("div", { className: Styles_module_scss_1.default["featured-content"] },
            items &&
                items.map(function (item) {
                    return (React.createElement("div", { className: Styles_module_scss_1.default["featured-content-item"] + " " + (isEditMode ? Styles_module_scss_1.default["edit"] : ""), key: "item-" + items.indexOf(item), role: "link", id: "item-" + items.indexOf(item), draggable: isEditMode, onDragStart: _this.webpart.startDrag.bind(_this.webpart), onMouseDown: _this.webpart.mouseDragDown.bind(_this.webpart), onDragEnter: _this.webpart.moveItem.bind(_this.webpart), onDragEnd: _this.webpart.endDrag.bind(_this.webpart), "data-index": items.indexOf(item) },
                        React.createElement("div", { role: "presentation", className: Styles_module_scss_1.default["box-container"] },
                            React.createElement("div", { className: Styles_module_scss_1.default["image"] },
                                React.createElement("img", { src: item["Image"] + FeaturedContentFactory_1.default.getWidthHeightQueryStringAppendForImage(item.Image), alt: item.ImageAlternate }),
                            ...
                            React.createElement("div", { className: Styles_module_scss_1.default["content"] },
                                React.createElement("div", { className: Styles_module_scss_1.default["title"] },
                                    React.createElement("a", { className: Styles_module_scss_1.default["featured-content-link"], href: item.URL, target: item.NewTab ? "_blank" : "" }, item.Title)),
                                React.createElement("span", { className: Styles_module_scss_1.default["description"] }, item.Description),
            ...
            (!items || items.length < 1) && isEditMode &&
                Array.apply(null, Array(1 - (items ? items.length : 0))).map(function (o, i) {
                    return (React.createElement("div", { className: Styles_module_scss_1.default["featured-content-item"] + Styles_module_scss_1.default["empty"] },
...
exports.default = BasicStackedLayout;

//# sourceMappingURL=BasicStackedLayout.js.map
