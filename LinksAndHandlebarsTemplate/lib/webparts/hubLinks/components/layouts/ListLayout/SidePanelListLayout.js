...
var BasicHorizontalTitleLayout = (function () {
    ...
    BasicHorizontalTitleLayout.prototype.render = function (items, isEditMode) {
        var _this = this;
        return (React.createElement("ul", { id: "myUnorderList", className: LLStyles_module_scss_1.default["hubLinks"] + " ms-CommandBarItem-iconColor " + LLStyles_module_scss_1.default["blue"] + (this.webpart.props.isEdit ? " " + LLStyles_module_scss_1.default["edit"] : "") },
            items &&
                items.map(function (item) {
                    return (React.createElement("li", { className: "listItemFullWidth", key: "item-" + items.indexOf(item), role: "link", id: "item-" + items.indexOf(item), draggable: isEditMode, onDragStart: _this.webpart.startDrag.bind(_this.webpart), onMouseDown: _this.webpart.mouseDragDown.bind(_this.webpart), onDragEnter: _this.webpart.moveItem.bind(_this.webpart), onDragEnd: _this.webpart.endDrag.bind(_this.webpart), "data-index": items.indexOf(item) },
...
//# sourceMappingURL=SidePanelListLayout.js.map
