...
var PropertyFieldGroupSortHost = (function (_super) {
    ...
    PropertyFieldGroupSortHost.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: PropertyFields_module_scss_1.default.groupSort },
            React.createElement(Label_1.Label, null, this.props.label),
            React.createElement("div", null,
                React.createElement(Button_1.CommandButton, { className: PropertyFields_module_scss_1.default.groupButton, onClick: this.moveUp.bind(this) },
                    React.createElement("i", { className: 'fa fa-caret-up' }),
                    React.createElement("span", null, "Move Up")),
                React.createElement(Button_1.CommandButton, { className: PropertyFields_module_scss_1.default.groupButton, onClick: this.moveDown.bind(this) },
                ...
                this.state.currentValue.length > 0 &&
                    this.state.currentValue.map(function (item, index) {
                        return (React.createElement("div", { className: PropertyFields_module_scss_1.default.groupListItem + (_this.state.selectedIndex == index ? " " + PropertyFields_module_scss_1.default.highlight : ""), key: "group-" + index, onClick: _this.setSelectItem.bind(_this, index) },
...
exports.default = PropertyFieldGroupSortHost;
