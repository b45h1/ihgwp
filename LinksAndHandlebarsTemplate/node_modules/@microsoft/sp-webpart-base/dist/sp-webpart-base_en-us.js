define("974a7777-0990-4136-8fa6-95d80114c2e0_1.5.0", ["@microsoft/sp-component-base","@microsoft/sp-core-library","react","@microsoft/sp-diagnostics","@microsoft/sp-lodash-subset","@microsoft/office-ui-fabric-react-bundle","@ms/sp-telemetry","@microsoft/load-themed-styles","@microsoft/decorators","react-dom","@microsoft/sp-http","@ms/sp-load-themed-styles","@microsoft/sp-loader","@microsoft/sp-page-context"], function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_9__, __WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_12__, __WEBPACK_EXTERNAL_MODULE_13__, __WEBPACK_EXTERNAL_MODULE_14__, __WEBPACK_EXTERNAL_MODULE_15__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2),__webpack_require__(9),__webpack_require__(3),__webpack_require__(4),__webpack_require__(5),__webpack_require__(6),__webpack_require__(7),__webpack_require__(8),__webpack_require__(1),__webpack_require__(10),__webpack_require__(11),__webpack_require__(12),__webpack_require__(13),__webpack_require__(14),__webpack_require__(15)], __WEBPACK_AMD_DEFINE_RESULT__ = function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_9__, __WEBPACK_EXTERNAL_MODULE_11__, __WEBPACK_EXTERNAL_MODULE_12__, __WEBPACK_EXTERNAL_MODULE_13__, __WEBPACK_EXTERNAL_MODULE_14__, __WEBPACK_EXTERNAL_MODULE_20__, __WEBPACK_EXTERNAL_MODULE_21__, __WEBPACK_EXTERNAL_MODULE_22__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// install a JSONP callback for chunk loading
/******/ 	var parentJsonpFunction = window["webpackJsonp974a7777_0990_4136_8fa6_95d80114c2e0_1_5_0"];
/******/ 	window["webpackJsonp974a7777_0990_4136_8fa6_95d80114c2e0_1_5_0"] = function webpackJsonpCallback(chunkIds, moreModules, executeModules) {
...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + chunkId + "." + ({}[chunkId]||chunkId) + "_" + {"0":"320b06937d3cae1e96f3","1":"1b977e6c5da7fc7410b5"}[chunkId] + ".js";
...
(function (PropertyPaneFieldType) {
    ...
    PropertyPaneFieldType[PropertyPaneFieldType["DynamicData"] = 14] = "DynamicData";
...
/* harmony default export */ __webpack_exports__["a"] = (strings['_ZRJdhh/Ht8a/UwYAwPqP9Q']);
...
var strings = ( false) ?
    require("../../resx-strings/en-us.json") :
    __webpack_require__(13);
/* harmony default export */ var Strings_resx = (strings['_cUY5i3OR5M46pep9mRCR0g']);
...
var ViewportLoader_ViewportLoader = (function () {
    ...
    ViewportLoader.prototype._dispose = function () {
        ...
        sp_telemetry_["_EngagementLogger"].logEvent('Webpart.ViewportLoad.Completed', timeSpent.toString());
        this._isInitialized = false;
...
var styles = {
    errorBox: 'errorBox_aac94cd0',
    errorBoxText: 'errorBoxText_aac94cd0',
    detailsButton: 'detailsButton_aac94cd0',
    somethingWentWrongText: 'somethingWentWrongText_aac94cd0',
    siteAdminText: 'siteAdminText_aac94cd0',
    screenReaderOnly: 'screenReaderOnly_aac94cd0',
};
...
var BaseClientSideWebPart_BaseClientSideWebPart = (function (_super) {
    ...
    function BaseClientSideWebPart() {
        ...
        _this._asyncRenderQosMonitor = new sp_telemetry_["_QosMonitor"]("WebPartAsyncRender");
    ...
    BaseClientSideWebPart.prototype._getPropertyPaneData = function () {
        ...
        return this._loadPropertyPaneResources().then(function () {
            ...
            return {
                ...
                properties: sp_lodash_subset_["cloneDeep"](_this.properties),
    ...
    BaseClientSideWebPart.prototype.onDisplayModeChanged = function (oldDisplayMode) {
        var qos = new sp_telemetry_["_QosMonitor"]('BaseClientSideWebpart.onDisplayModeChanged');
    ...
    BaseClientSideWebPart.prototype._internalInitialize = function (webPartContext) {
        ...
        sp_diagnostics_["_TraceLogger"].logVerbose(this._logSource, sp_core_library_["Text"].format(Strings_resx.ConstructLog, webPartContext.webPartTag));
    ...
    BaseClientSideWebPart.prototype._internalFirstTimeRender = function (addedFromPersistedData, mode, qosMonitor, data, scrollableParent) {
        var _this = this;
        if (mode === void 0) { mode = sp_core_library_["DisplayMode"].Read; }
        ...
        return new Promise(function (resolve) {
            if (!_this._initialized && qosMonitor) {
                ...
                throw SPWebPartError_SPWebPartError.create(SPWebPartErrorCode.NotInitializedError, _this.context.webPartTag);
            }
            ...
            if (!_this._renderedFromPersistedData) {
                ...
                var logEntry = new sp_diagnostics_["_LogEntry"](_this._logSource.id, 'WebPartAdded', sp_diagnostics_["_LogType"].Event, {
    ...
    BaseClientSideWebPart.prototype._internalRenderInViewPort = function () {
        ...
        if (!this._initPromise) {
            throw SPWebPartError_SPWebPartError.create(SPWebPartErrorCode.OnInitReturnedNullPromise, this.context.webPartTag);
        }
        this._initPromise.then(function () {
            ...
            getDataPromise.then(function () {
                ...
                if (!sp_core_library_["_SPKillSwitch"].isActivated(sp_core_library_["Guid"].parse('a2a8cd1a-fc93-46be-a361-309922babbcf'), '4/6/2018', 'WaitRender')) {
        ...
        configuration.pages.forEach(function (page) {
            page.groups.forEach(function (group) {
                group.groupFields.forEach(function (field) {
                    if (field.type === IPropertyPaneField["a" /* PropertyPaneFieldType */].DynamicData) {
                        if (!field.properties) {
                            field.properties = {
                                entries: []
                            };
                    ...
                    else if (field.type === IPropertyPaneField["a" /* PropertyPaneFieldType */].DynamicTextField) {
                        var props = field.properties;
                        props.dynamicDataProvider = _this.context.dynamicDataProvider;
    ...
    BaseClientSideWebPart.prototype._onPropertyPaneFieldChanged = function (propertyPath, newValue) {
        if (this.disableReactivePropertyChanges && !this._backupProperties) {
            this._backupProperties = sp_lodash_subset_["cloneDeep"](this.properties);
        }
    ...
    BaseClientSideWebPart.prototype._serialize = function () {
        ...
        var properties = sp_lodash_subset_["cloneDeep"](this.persistedProperties);
    ...
    BaseClientSideWebPart.prototype._internalSerialize = function () {
        ...
        executeAndReThrow(function () {
            ...
            if (!_this._hasEditLogged && _this._initPropertiesSnapshot !== propertiesJson) {
                ...
                var logEntry = new sp_diagnostics_["_LogEntry"](_this._logSource.id, 'WebPartEdited', sp_diagnostics_["_LogType"].Event, {
                    'alias': _this.context.manifest.alias,
                    'isInternal': isInternal.toString()
                });
                sp_telemetry_["_EngagementLogger"].logEventWithLogEntry(logEntry);
        ...
        }, SPWebPartError_SPWebPartError.create(SPWebPartErrorCode.SerializationFailed, this.context.webPartTag), this._logSource);
        return data;
    };
    ...
    BaseClientSideWebPart.prototype._internalDispose = function () {
        sp_diagnostics_["_TraceLogger"].logVerbose(this._logSource, sp_core_library_["Text"].format(Strings_resx.DisposeLog, this.context.webPartTag));
    ...
    BaseClientSideWebPart.prototype._throwReadOnlyError = function () {
        throw SPWebPartError_SPWebPartError.create(SPWebPartErrorCode.ReadOnlyProperty);
    };
    BaseClientSideWebPart.prototype._renderWithAccessibleTitle = function () {
        var _this = this;
        var renderWithAccessibleTitle = function () {
            sp_telemetry_["_PerformanceLogger"].devMark("webpart(" + _this.context.webPartTag + ")._renderWithAccessibleTitle");
            _this.render();
            if (_this._displayMode === sp_core_library_["DisplayMode"].Edit) {
                ...
                classicPages_ClassicPageUtils.disableAutomaticPostbacks(_this.domElement, sp_core_library_["Environment"].type);
            }
            _this.domElement.style.minHeight = null; 
            return Promise.resolve(undefined);
        };
        if (!sp_core_library_["_SPKillSwitch"].isActivated(sp_core_library_["Guid"].parse('a2a8cd1a-fc93-46be-a361-309922babbcf'), '4/6/2018', 'Wait on onInit') &&
            this._initPromise) {
    ...
    BaseClientSideWebPart.prototype._resolveOnRenderPromise = function () {
        ...
        sp_telemetry_["_PerformanceLogger"].endMarkForComponent(this.context.webPartTag);
...
var sp_load_themed_styles_ = __webpack_require__(20);
...
var sp_loader_ = __webpack_require__(21);
...
var loc_Strings_resx = __webpack_require__(15);
...
var PropertyPaneController_PropertyPaneController = (function () {
    function PropertyPaneController(getConsumer, callback) {
        ...
        sp_core_library_["Validate"].isNotNullOrUndefined(getConsumer, 'getConsumer');
    ...
    PropertyPaneController.prototype.requestAction = function (toBeConfiguredConsumerId, propertyPaneAction, renderedByWebPart) {
        ...
        if (!noOp) {
            var toBeConfiguredConsumer = this._getConsumer(toBeConfiguredConsumerId);
    ...
    PropertyPaneController.prototype._renderPropertyPane = function (currentConsumer, recreatePropertyPane, reset) {
        var _this = this;
        var qosMonitor = new sp_telemetry_["_QosMonitor"]('PropertyPaneController.renderPropertyPane');
        if (currentConsumer) {
    ...
    PropertyPaneController.prototype._buildAndLoadPropertyPane = function (propertyPaneData, reset) {
        ...
        propertyPaneData.render = function () { _this._render(); };
    ...
    PropertyPaneController.prototype._loadPropertyPaneComponent = function (recreatePropertyPane) {
        var _this = this;
        __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 110))
    ...
    PropertyPaneController.prototype._render = function () {
        var wp = this._getConsumer(this._currentPropertyPaneData.webPartId);
        if (wp) {
    ...
    PropertyPaneController.prototype._onPropertyPaneFieldChanged = function (propertyName, newValue) {
        ...
        var wp = this._getConsumer(this._currentPropertyPaneData.webPartId);
        if (wp) {
            wp._onPropertyPaneFieldChanged(propertyName, newValue);
            this._renderPropertyPane(wp);
        }
        if (this._isCurrentlyConfiguredPropertyPaneReactive()) {
    ...
    PropertyPaneController.prototype._fireConfigurationEvent = function (componentId, configurationEvent) {
        ...
        var consumer = this._getConsumer(componentId);
        if (consumer) {
    ...
    PropertyPaneController.prototype._isCurrentlyConfiguredPropertyPaneReactive = function () {
        if (this._currentlyConfiguredConsumerId) {
            var currentlyConfiguredWebPart = this._getConsumer(this._currentlyConfiguredConsumerId);
            var isReactive = this._currentPropertyPaneData ?
                this._currentPropertyPaneData.isReactive :
                !currentlyConfiguredWebPart.disableReactivePropertyChanges;
            return !!isReactive;
        }
        return false;
    };
...
var ClientSideWebPartManager_ClientSideWebPartManager = (function () {
    ...
    ClientSideWebPartManager.prototype.loadWebPart = function (context) {
        ...
        var loadWebPartPromise = new Promise(function (resolve, reject) {
            ...
            sp_telemetry_["_PerformanceLogger"].devMark("ClientSideWebPartManager.loadWebPart(" + webPartTag + ").start");
            ...
            if (!_this._validateManifest(context.manifest, context.displayMode, webPartTag)) {
                _this.renderError(context.domElement, SPWebPartError_SPWebPartError.create(SPWebPartErrorCode.ManifestInvalid, webPartTag));
                return;
            }
            ...
            sp_telemetry_["_PerformanceLogger"].startMarkForComponent(webPartTag);
            sp_diagnostics_["_TraceLogger"].logVerboseData({
                source: _this._logSource,
            ...
            modulePromise = sp_loader_["SPComponentLoader"].loadComponent(manifest);
            if (!modulePromise) {
                var error = SPWebPartError_SPWebPartError.create(SPWebPartErrorCode.LoaderNotFound, webPartTag);
            ...
            _this._loadDynamicComponentDependencies(context.webPartData, webPartTag, moduleLoadPromises);
            Promise.all(moduleLoadPromises)
                .then(function (moduleLibrararies) {
                sp_telemetry_["_PerformanceLogger"].devMark("ClientSideWebPartManager.loadWebPart(" + webPartTag + ").end");
                return _this._initializeAndRenderWebPart({
                    context: context,
                    moduleLibrary: moduleLibrararies[0],
        ...
        if (sp_core_library_["Environment"].type !== sp_core_library_["EnvironmentType"].ClassicSharePoint &&
            ...
            var addedPromise = modulePromise || Promise.reject('No module promise');
    ...
    ClientSideWebPartManager.prototype.fetchWebPartManifests = function () {
        ...
        if (!this._toolboxManifestsPromise) {
            ...
            var qosMonitor_1 = new sp_telemetry_["_QosMonitor"]('ClientSideWebPartManager.FetchWebParts');
            this._toolboxManifestsPromise = new Promise(function (resolve, reject) {
                if (_this._pageContext.web &&
                    ...
                    var requestUrl_1 = sp_core_library_["UrlUtilities"].removeEndSlash(_this._pageContext.web.serverRelativeUrl) + "/_api/web/GetClientSideWebParts";
                    _this._host.serviceScope.whenFinished(function () {
                        ...
                        httpClient.get(requestUrl_1, sp_http_["SPHttpClient"].configurations.v1)
    ...
    ClientSideWebPartManager.prototype.requestPropertyPaneAction = function (instanceId, propertyPaneAction, renderedByWebPart) {
        ...
        ClientSideWebPartManager._propertyPaneController.requestAction(instanceId, propertyPaneAction, renderedByWebPart);
    };
    ...
    ClientSideWebPartManager.prototype._createLoadQosMonitor = function (manifest) {
        return new sp_telemetry_["_QosMonitor"]("WebPart.Load", true);
    };
    ...
    ClientSideWebPartManager.prototype._propertyPaneLifeCycleEventCallback = function (event, webpartInstanceId) {
        ClientSideWebPartManager._webPartManagerList.forEach(function (wpm) {
            if (wpm._host.propertyPaneLifeCycleEventCallback &&
                (ClientSideWebPartManager._propertyPaneController.currentlyConfiguredConsumerId &&
                    wpm._webparts.get(ClientSideWebPartManager._propertyPaneController.currentlyConfiguredConsumerId) ||
                    event === 7 )) {
    ...
    ClientSideWebPartManager.prototype._initializeAndRenderWebPart = function (options) {
        var context = options.context, moduleLibrary = options.moduleLibrary, webPartTag = options.webPartTag, qosMonitor = options.qosMonitor, instanceRequestCount = options.instanceRequestCount;
        try {
            ...
            if (!moduleLibrary) {
                return Promise.reject(SPWebPartError_SPWebPartError.create(SPWebPartErrorCode.ModuleUndefined, webPartTag));
            }
            ...
            var webpartFirstRenderPromise = wpi._internalFirstTimeRender(context.addedFromPersistedData, context.displayMode, qosMonitor, webPartData, 
            context.scrollableParent);
            ...
            if (componentDependencies) {
                for (var compDependency in componentDependencies) {
                    if (compDependency && componentDependencies[compDependency]) {
                        ...
                        if (!sp_core_library_["Guid"].tryParse(componentId)) {
                        ...
                        else if (sp_loader_["SPComponentLoader"].tryGetManifestById(componentId)) {
                            ...
                            var error = new Error("Manifest not found for dynamic dependency " + compDependency + " of web part (" + webPartTag + ")");
                            sp_diagnostics_["_TraceLogger"].logErrorData({ source: this._logSource, error: error, serviceScope: this._host.serviceScope });
                        }
                    }
                }
...
var MaintenanceModeRenderer_MaintenanceModeRenderer = (function () {
    ...
    MaintenanceModeRenderer.render = function (context, data) {
        return __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 111))
...
var ScrollEventHandler_ScrollEventHandler = (function () {
    ...
    Object.defineProperty(ScrollEventHandler.prototype, "_cacheExpired", {
        get: function () {
            return (this._cachedClientRectAge - Date.now() >= ScrollEventHandler.CACHE_EXPIRED);
        },
        enumerable: true,
        configurable: true
    });
...
// CONCATENATED MODULE: ./lib/propertyPane/propertyPaneFields/propertyPaneDynamicData/PropertyPaneDynamicData.js

function PropertyPaneDynamicData(targetProperty, label) {
    return {
...
function PropertyPaneMultipleDynamicData(entries) {
    return {
        type: IPropertyPaneField["a" /* PropertyPaneFieldType */].DynamicData,
        targetProperty: '',
...
var BasePropertyPaneConsumer = (function () {
    ...
    Object.defineProperty(BasePropertyPaneConsumer.prototype, "disableReactivePropertyChanges", {
        get: function () { return false; },
        enumerable: true,
        configurable: true
    });
    ...
    BasePropertyPaneConsumer.prototype._internalSerialize = function () {
        return undefined;
    };
...
var DeferredComponent_DeferredComponent = (function (_super) {
    ...
    function DeferredComponent(props) {
        var _this = _super.call(this, props) || this;
        if (!_this._isLifeCycleUpdateKillSwitchActivated()) {
            _this.state = {
    ...
    DeferredComponent.prototype.componentWillMount = function () {
        if (!this._isLifeCycleUpdateKillSwitchActivated()) {
    ...
    DeferredComponent.prototype.componentDidMount = function () {
        if (this.state.component && !this._isLifeCycleUpdateKillSwitchActivated()) {
            return;
        }
    ...
    DeferredComponent.prototype.load = function () {
        ...
        else if (!this._isLifeCycleUpdateKillSwitchActivated()) {
            this.constructor._loadPromise.then(this._handleComponentLoaded);
        }
    ...
    DeferredComponent.prototype._isLifeCycleUpdateKillSwitchActivated = function () {
        return sp_core_library_["_SPKillSwitch"].isActivated(DeferredComponent._lifeCycleUpdateKillSwitchGuid, '03/01/18', 'DeferredComponentLifeCycle');
    };
    DeferredComponent._lifeCycleUpdateKillSwitchGuid = sp_core_library_["Guid"].parse('5d2c1255-f718-47b0-a8b1-80813ae65e90');
    tslib_es6["b" /* __decorate */]([
        office_ui_fabric_react_bundle_["autobind"]
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "PropertyPaneDynamicData", function() { return PropertyPaneDynamicData; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "PropertyPaneMultipleDynamicData", function() { return PropertyPaneMultipleDynamicData; });
