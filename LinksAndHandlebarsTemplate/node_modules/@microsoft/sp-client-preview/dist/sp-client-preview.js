define("4d5eb168-6729-49a8-aec7-0e397f486b6e_1.5.0", ["@microsoft/sp-http","@microsoft/sp-core-library","@microsoft/sp-lodash-subset","@ms/sp-telemetry"], function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
// EXTERNAL MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/@microsoft/microsoft-graph-client/1.0.0/node_modules/@microsoft/microsoft-graph-client/lib/graph-js-sdk-web.js
var graph_js_sdk_web = __webpack_require__(2);
var graph_js_sdk_web_default = /*#__PURE__*/__webpack_require__.n(graph_js_sdk_web);
...
var sp_lodash_subset_ = __webpack_require__(5);
...
var MSGraphClient_MSGraphClient = (function () {
    function MSGraphClient(serviceScope) {
        ...
        serviceScope.whenFinished(function () {
            if (!MSGraphClient._instance) {
                _this._configureGraphSDK(sp_http_["_AadTokenProviders"].getConfigurable(), serviceScope.consume(sp_http_["_GraphHttpClientContext"].serviceKey));
            }
        });
    }
    ...
    MSGraphClient.prototype.api = function (path, config) {
        ...
        MSGraphClient._instance.config = Object(sp_lodash_subset_["clone"])(this._originalConfig);
        if (config) {
    ...
    MSGraphClient.prototype._getOAuthToken = function (tokenProvider) {
        var qosMonitor = new sp_telemetry_["_QosMonitor"]('MSGraphClient.FetchGraphToken');
    ...
    MSGraphClient.serviceKey = sp_core_library_["ServiceKey"].create('sp-http:MSGraphClient', MSGraphClient);
...
},{"../../package.json":16,"./ResponseHandler":3,"./common":4,"es6-promise":7,"superagent":9}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./is-function":10,"./is-object":11,"./request-base":12,"./response-base":13,"./should-retry":14,"component-emitter":6}],10:[function(require,module,exports){
/**
