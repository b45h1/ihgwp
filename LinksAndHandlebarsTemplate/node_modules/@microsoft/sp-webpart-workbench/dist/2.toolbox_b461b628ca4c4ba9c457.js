webpackJsonp8be81a5c_af38_4bb2_af97_afa3b64dfbed_1_5_0([2],{
...
// module
exports.push([module.i, ".error_c8103efd{background-color:\"[theme:errorBackground, default: #fde7e9]\";font-weight:600;font-size:12px;letter-spacing:1px;padding:0 12px}", ""]);
...
// module
exports.push([module.i, ".toolboxGroup_ad92ac52{clear:both;position:relative}.header_ad92ac52{background-color:\"[theme:neutralLighter, default: #f4f4f4]\";color:\"[theme:neutralPrimary, default: #333333]\";font-weight:600;height:32px;letter-spacing:1px;line-height:32px;padding:0 12px}[dir=ltr] .header_ad92ac52{text-align:left}[dir=rtl] .header_ad92ac52{text-align:right}.seeAllButton_ad92ac52{height:32px;color:\"[theme:blue, default: #0078d4]\";position:absolute;top:0}[dir=ltr] .seeAllButton_ad92ac52{right:0}[dir=rtl] .seeAllButton_ad92ac52{left:0}", ""]);
...
// module
exports.push([module.i, ".flexGroup_7466c5d1{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-pack:start;justify-content:flex-start;-ms-flex-align:center;align-items:center}.grid_7466c5d1{width:128px;height:128px}.eightColumnWide_7466c5d1{width:1024px}.sevenColumnWide_7466c5d1{width:896px}.sixColumnWide_7466c5d1{width:768px}.fiveColumnWide_7466c5d1{width:640px}.fourColumnWide_7466c5d1{width:512px}", ""]);
...
// module
exports.push([module.i, ".chrome_4497a24e{height:100%;position:relative;display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column}.chrome_4497a24e .searchBox_4497a24e{-ms-flex:0 0 auto;flex:0 0 auto;margin-bottom:0;border-width:0;box-sizing:border-box;height:33px;border-bottom:1px solid;border-color:\"[theme:neutralLight, default: #eaeaea]\";width:100%}[dir=ltr] .chrome_4497a24e .searchBox_4497a24e{padding-right:32px}[dir=rtl] .chrome_4497a24e .searchBox_4497a24e{padding-left:32px}.chrome_4497a24e .searchBox_4497a24e:hover{border-color:\"[theme:neutralLight, default: #eaeaea]\"}.chrome_4497a24e .farButton_4497a24e{box-sizing:border-box;width:32px;height:32px;position:absolute;top:0}[dir=ltr] .chrome_4497a24e .farButton_4497a24e{right:0}[dir=rtl] .chrome_4497a24e .farButton_4497a24e{left:0}.chrome_4497a24e .commandBar_4497a24e{-ms-flex:0 0 auto;flex:0 0 auto}.chrome_4497a24e .content_4497a24e{-ms-flex:1 1 auto;flex:1 1 auto;overflow-y:scroll;height:100%}", ""]);
...
// module
exports.push([module.i, ".item_732033a6{width:33.3%;height:88px}.flexBox_732033a6{padding:10px 8px 0}.flexBox_732033a6>*+*{margin-top:10px}.icon_732033a6{width:82px;height:28px;min-height:28px;font-size:28px;line-height:28px}.title_732033a6{font-size:13px}", ""]);
...
// module
exports.push([module.i, ".item_b229efe5{height:100%;width:100%;border-width:2px}.flexBox_b229efe5{padding:23px 8px 0}.flexBox_b229efe5>*+*{margin-top:8px}.icon_b229efe5{width:82px;height:32px;min-height:32px;font-size:32px;line-height:32px}.title_b229efe5{font-size:14px}", ""]);
...
// module
exports.push([module.i, ".noResultFoundContainer_e82c437b{height:100%}.noResultFound_e82c437b{height:100%;display:-ms-flexbox;display:flex;-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center}.noResultFoundIcon_e82c437b{margin-bottom:18px;font-size:32px}[dir=ltr] .noResultFoundIcon_e82c437b{margin-right:14px}[dir=rtl] .noResultFoundIcon_e82c437b{margin-left:14px}.noResultFoundLabelContainer_e82c437b{display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;-ms-flex-align:center;align-items:center}.noResultLabel_e82c437b{font-size:21px;font-weight:100;margin-bottom:4px}.noResultLabel_e82c437b,.tryAgainLabel_e82c437b{color:\"[theme:neutralSecondary, default: #666666]\"}.tryAgainLabel_e82c437b{font-size:17px;font-weight:300}", ""]);
...
// module
exports.push([module.i, ".toolboxLargeContainer_d3bf3dc1{margin:24px;height:712px;display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column}.screenReaderAlert_d3bf3dc1{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);border:0}.menuCommandBar_d3bf3dc1{height:40px;background-color:\"[theme:neutralLight, default: #eaeaea]\"}.menuCommandBar_d3bf3dc1 .ms-CommandBar-primaryCommands{margin:0 4px}.menuCommandBar_d3bf3dc1 .ms-CommandBarItem-commandText{font-size:21px}.selectedItem_d3bf3dc1{font-weight:600;background-color:\"[theme:neutralLight, default: #eaeaea]\"}", ""]);
...
// module
exports.push([module.i, ".noResults_a2e36e45{-ms-flex-align:center;align-items:center;display:-ms-flexbox;display:flex;font-size:13px;-ms-flex-pack:center;justify-content:center;padding:13px}", ""]);
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxData/RTEStrings.resx.js
var strings = ( false) ?
    require("../resx-strings/en-us.json") :
    __webpack_require__(15);
/* harmony default export */ var RTEStrings_resx = (strings['_RRzf46hnc4+fBX8RHyocNg']);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxData/RTE.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxData/GroupStrings.resx.js
var GroupStrings_resx_strings = ( false) ?
    require("../resx-strings/en-us.json") :
    __webpack_require__(15);
/* harmony default export */ var GroupStrings_resx = (GroupStrings_resx_strings['_NS+5Kf9zpnH1/LStsp+Tfw']);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxData/Group.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxData/index.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxError/ToolboxError.module.scss.js
__webpack_require__(333);
var styles = {
    error: 'error_c8103efd',
};
/* harmony default export */ var ToolboxError_module_scss = (styles);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxError/ToolboxError.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxError/ToolboxErrorAnimationLayer.js


var ToolboxErrorAnimationLayer = Object(toolboxAnimation["a" /* animation */])(ToolboxError, 2 );

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxError/index.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxGroup/ToolboxGroupBase.module.scss.js
__webpack_require__(335);
var ToolboxGroupBase_module_scss_styles = {
    toolboxGroup: 'toolboxGroup_ad92ac52',
    header: 'header_ad92ac52',
    seeAllButton: 'seeAllButton_ad92ac52',
};
/* harmony default export */ var ToolboxGroupBase_module_scss = (ToolboxGroupBase_module_scss_styles);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxGroup/ToolboxGroupStrings.resx.js
var ToolboxGroupStrings_resx_strings = ( false) ?
    require("../resx-strings/en-us.json") :
    __webpack_require__(15);
/* harmony default export */ var ToolboxGroupStrings_resx = (ToolboxGroupStrings_resx_strings['_2TT4IG31kAjRqhD0h5kPOg']);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxGroup/ToolboxGroupBase.js
...
var ToolboxGroupBase_ToolboxGroupBase = (function (_super) {
    tslib_es6["c" /* __extends */](ToolboxGroupBase, _super);
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxGroup/ToolboxGroupLarge.module.scss.js
__webpack_require__(337);
var ToolboxGroupLarge_module_scss_styles = {
    flexGroup: 'flexGroup_7466c5d1',
    grid: 'grid_7466c5d1',
    eightColumnWide: 'eightColumnWide_7466c5d1',
    sevenColumnWide: 'sevenColumnWide_7466c5d1',
    sixColumnWide: 'sixColumnWide_7466c5d1',
    fiveColumnWide: 'fiveColumnWide_7466c5d1',
    fourColumnWide: 'fourColumnWide_7466c5d1',
};
/* harmony default export */ var ToolboxGroupLarge_module_scss = (ToolboxGroupLarge_module_scss_styles);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxGroup/ToolboxGroupLarge.js
...
var ToolboxGroupLarge_ToolboxGroupLarge = (function (_super) {
    tslib_es6["c" /* __extends */](ToolboxGroupLarge, _super);
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxGroup/ToolboxGroupSmall.js



var ToolboxGroupSmall_ToolboxGroupSmall = (function (_super) {
    tslib_es6["c" /* __extends */](ToolboxGroupSmall, _super);
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxGroup/ToolboxGroupUtilities.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxGroup/index.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxChrome/ToolboxChrome.module.scss.js
__webpack_require__(339);
var ToolboxChrome_module_scss_styles = {
    chrome: 'chrome_4497a24e',
    searchBox: 'searchBox_4497a24e',
    farButton: 'farButton_4497a24e',
    commandBar: 'commandBar_4497a24e',
    content: 'content_4497a24e',
};
/* harmony default export */ var ToolboxChrome_module_scss = (ToolboxChrome_module_scss_styles);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxChrome/ToolboxChromeStrings.resx.js
var ToolboxChromeStrings_resx_strings = ( false) ?
    require("../resx-strings/en-us.json") :
    __webpack_require__(15);
/* harmony default export */ var ToolboxChromeStrings_resx = (ToolboxChromeStrings_resx_strings['_4SOrKBlkyRLkXWcT6txoow']);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxChrome/ToolboxChrome.js
...
var ToolboxChrome_ToolboxChrome = (function (_super) {
    tslib_es6["c" /* __extends */](ToolboxChrome, _super);
    function ToolboxChrome() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ToolboxChrome.prototype.componentDidMount = function () {
        if (this._searchBoxContainer) {
            var input = external__react_dom_["findDOMNode"](this._searchBoxContainer).querySelector('input');
            if (input) {
    ...
    Object.defineProperty(ToolboxChrome.prototype, "_commandBar", {
        get: function () {
            ...
            return (external__react_["createElement"](office_ui_fabric_react_bundle_["CommandBar"], tslib_es6["a" /* __assign */]({}, commandBarProps)));
        },
        enumerable: true,
        configurable: true
    });
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxChrome/index.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxItem/ToolboxItemSmall.module.scss.js
__webpack_require__(341);
var ToolboxItemSmall_module_scss_styles = {
    item: 'item_732033a6',
    flexBox: 'flexBox_732033a6',
    icon: 'icon_732033a6',
    title: 'title_732033a6',
};
/* harmony default export */ var ToolboxItemSmall_module_scss = (ToolboxItemSmall_module_scss_styles);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxItem/ToolboxItemSmall.js




function ToolboxItemSmall(props) {
    return (external__react_["createElement"](ToolboxItemBase["a" /* ToolboxItemBase */], tslib_es6["a" /* __assign */]({}, props, { titleLineCount: 2, itemClassName: ToolboxItemSmall_module_scss.item, itemStyles: { height: 88 }, flexBoxClassName: ToolboxItemSmall_module_scss.flexBox, iconClassName: ToolboxItemSmall_module_scss.icon, titleClassName: ToolboxItemSmall_module_scss.title, "data-item-size": 'small' })));
}

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxItem/ToolboxItemLarge.module.scss.js
__webpack_require__(343);
var ToolboxItemLarge_module_scss_styles = {
    item: 'item_b229efe5',
    flexBox: 'flexBox_b229efe5',
    icon: 'icon_b229efe5',
    title: 'title_b229efe5',
};
/* harmony default export */ var ToolboxItemLarge_module_scss = (ToolboxItemLarge_module_scss_styles);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxItem/ToolboxItemLarge.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxItem/index.js



// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxLarge/ViewCategory.js
...
var ViewCategory_ViewCategory = (function (_super) {
    tslib_es6["c" /* __extends */](ViewCategory, _super);
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxLarge/ViewHome.js




var ViewHome_ViewHome = (function (_super) {
    tslib_es6["c" /* __extends */](ViewHome, _super);
    function ViewHome() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxLarge/ToolboxLargeStrings.resx.js
var ToolboxLargeStrings_resx_strings = ( false) ?
    require("../resx-strings/en-us.json") :
    __webpack_require__(15);
/* harmony default export */ var ToolboxLargeStrings_resx = (ToolboxLargeStrings_resx_strings['_WVn4QXYnL8WpGCqr2C9ySA']);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxLarge/ViewSearch.module.scss.js
__webpack_require__(345);
var ViewSearch_module_scss_styles = {
    noResultFoundContainer: 'noResultFoundContainer_e82c437b',
    noResultFound: 'noResultFound_e82c437b',
    noResultFoundIcon: 'noResultFoundIcon_e82c437b',
    noResultFoundLabelContainer: 'noResultFoundLabelContainer_e82c437b',
    noResultLabel: 'noResultLabel_e82c437b',
    tryAgainLabel: 'tryAgainLabel_e82c437b',
};
/* harmony default export */ var ViewSearch_module_scss = (ViewSearch_module_scss_styles);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxLarge/ViewSearch.js
...
var ViewSearch_ViewSearch = (function (_super) {
    tslib_es6["c" /* __extends */](ViewSearch, _super);
    function ViewSearch() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxLarge/ViewSort.js




var ViewSort_ViewSort = (function (_super) {
    tslib_es6["c" /* __extends */](ViewSort, _super);
    function ViewSort() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxLarge/ToolboxLarge.module.scss.js
__webpack_require__(347);
var ToolboxLarge_module_scss_styles = {
    toolboxLargeContainer: 'toolboxLargeContainer_d3bf3dc1',
    screenReaderAlert: 'screenReaderAlert_d3bf3dc1',
    menuCommandBar: 'menuCommandBar_d3bf3dc1',
    selectedItem: 'selectedItem_d3bf3dc1',
};
/* harmony default export */ var ToolboxLarge_module_scss = (ToolboxLarge_module_scss_styles);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxLarge/ToolboxLargeViewLayer.js
...
var ToolboxLargeViewLayer_ToolboxLargeViewLayer = (function (_super) {
    tslib_es6["c" /* __extends */](ToolboxLargeViewLayer, _super);
    ...
    ToolboxLargeViewLayer.prototype.render = function () {
        ...
        var subTitle = lib["StringHelper"].formatWithLocalizedCountValue(ToolboxLargeStrings_resx.LargeToolboxAriaSubTitle, ToolboxLargeStrings_resx.CountStringIntervals, this.props.items.length);
        ...
        return (external__react_["createElement"](office_ui_fabric_react_bundle_["Modal"], { onDismiss: function () { return _this.props.controller.closeToolbox(true ); }, containerClassName: Object(office_ui_fabric_react_bundle_["css"])(ToolboxLarge_module_scss.toolboxLargeContainer, this.props.className), isOpen: true, isBlocking: false, titleAriaId: titleAriaId, subtitleAriaId: subTitleAriaId },
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxLarge/ToolboxLargeAnimationLayer.js


var ToolboxLargeAnimationLayer = Object(toolboxAnimation["a" /* animation */])(ToolboxLargeViewLayer_ToolboxLargeViewLayer, 4 );

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxLarge/index.js


// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxSmall/ToolboxSmall.module.scss.js
__webpack_require__(349);
var ToolboxSmall_module_scss_styles = {
    noResults: 'noResults_a2e36e45',
};
/* harmony default export */ var ToolboxSmall_module_scss = (ToolboxSmall_module_scss_styles);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxSmall/ToolboxSmallStrings.resx.js
var ToolboxSmallStrings_resx_strings = ( false) ?
    require("../resx-strings/en-us.json") :
    __webpack_require__(15);
/* harmony default export */ var ToolboxSmallStrings_resx = (ToolboxSmallStrings_resx_strings['_CZsUWMvZilAKKAfwQSdzKQ']);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxSmall/ToolboxSmall.js
...
var ToolboxSmall_ToolboxSmall = (function (_super) {
    tslib_es6["c" /* __extends */](ToolboxSmall, _super);
    ...
    ToolboxSmall.prototype.componentDidMount = function () {
        var localizedItemCount = lib["StringHelper"].formatWithLocalizedCountValue(ToolboxSmallStrings_resx.CanvasItems, ToolboxSmallStrings_resx.CanvasItemsInterval, this._itemsCount);
        ...
        return (external__react_["createElement"](toolboxCallout["a" /* ToolboxCallout */], { onDismiss: function (isKeyboard) { return _this.props.controller.closeToolbox(isKeyboard ); }, horizontalPosition: this.props.horizontalPosition || 0, verticalPosition: this.props.verticalPosition || 0, className: this.props.className, scrollableParent: this.props.scrollableParent, canvasElement: this.props.canvasElement },
            external__react_["createElement"](ToolboxChrome_ToolboxChrome, { onSearch: this.props.controller.filter, onChange: this.props.controller.filterDebounce, onEscape: function () { return _this.props.controller.closeToolbox(true ); }, searchQuery: this.props.query, farButton: expandButtonProps },
                external__react_["createElement"](office_ui_fabric_react_bundle_["FocusZone"], { direction: office_ui_fabric_react_bundle_["FocusZoneDirection"].horizontal, isCircularNavigation: true },
                    ...
                    this._itemsCount === 0 && this._itemsNotFound))));
    };
    ...
    Object.defineProperty(ToolboxSmall.prototype, "_itemsCount", {
        get: function () {
            return (this.state.featuredGroup.items.length +
                this.state.alphabeticalGroup.items.length);
        },
        enumerable: true,
        configurable: true
    });
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxSmall/ToolboxSmallSearchLayer.js
...
var ToolboxSmallSearchLayer_ToolboxSmallSearchLayer = (function (_super) {
    tslib_es6["c" /* __extends */](ToolboxSmallSearchLayer, _super);
    ...
    ToolboxSmallSearchLayer.prototype.render = function () {
        return (external__react_["createElement"](ToolboxSmall_ToolboxSmall, tslib_es6["a" /* __assign */]({}, this.props, { ref: undefined, controller: this._controller, query: this.state.query, items: this.state.items })));
    };
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxSmall/ToolboxSmallAnimationLayer.js


var ToolboxSmallAnimationLayer = Object(toolboxAnimation["a" /* animation */])(ToolboxSmallSearchLayer_ToolboxSmallSearchLayer, 3 );

// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolboxSmall/index.js


// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolbox/ToolboxSizeLayer.js
...
var ToolboxSizeLayer_ToolboxSizeLayer = (function (_super) {
    tslib_es6["c" /* __extends */](ToolboxSizeLayer, _super);
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-canvas-toolbox/lib/toolbox/ToolboxItemsLayer.js
...
var ToolboxItemsLayer_ToolboxItemsLayer = (function (_super) {
    tslib_es6["c" /* __extends */](ToolboxItemsLayer, _super);
    ...
    ToolboxItemsLayer.prototype.clickItem = function (toolboxItemId, info) {
        ...
        this.props.onClickItem(tslib_es6["a" /* __assign */]({}, control, { position: this.props.position }));
        if (control.controlType === toolboxModel["a" /* CanvasControlType */].WebPartZone) {
            sp_telemetry_["_EngagementLogger"].logEventWithLogEntry(new sp_diagnostics_["_LogEntry"]('Toolbox', 'AddWebPart', sp_diagnostics_["_LogType"].Event, tslib_es6["a" /* __assign */]({ manifestId: manifest.id }, this._convertClickItemInfo(info))));
        }
        else if (control.controlType === toolboxModel["a" /* CanvasControlType */].RTE) {
            sp_telemetry_["_EngagementLogger"].logEventWithLogEntry(new sp_diagnostics_["_LogEntry"]('Toolbox', 'AddRTE', sp_diagnostics_["_LogType"].Event, tslib_es6["a" /* __assign */]({ source: info.size }, this._convertClickItemInfo(info))));
        }
        else {
            sp_telemetry_["_EngagementLogger"].logEventWithLogEntry(new sp_diagnostics_["_LogEntry"]('Toolbox', 'AddZone', sp_diagnostics_["_LogType"].Event, tslib_es6["a" /* __assign */]({ layout: toolboxModel["a" /* CanvasControlType */][control.controlType] }, this._convertClickItemInfo(info))));
        }
    ...
    ToolboxItemsLayer.prototype._logWebPartSource = function (groups) {
        ...
        if (this._isItemCountKillSwitchActivated || ToolboxItemsLayer._isWebPartSourceLogged || !map) {
            return;
        }
        var countMap = groups
    ...
    Object.defineProperty(ToolboxItemsLayer.prototype, "_isItemCountKillSwitchActivated", {
        get: function () {
            return sp_core_library_["_SPKillSwitch"].isActivated(sp_core_library_["Guid"].parse('9ae20ad3-7d30-44c5-9994-298a3ae370aa'), '3/23/2018', 'ToolboxLogItemCount');
        },
        enumerable: true,
        configurable: true
    });
...
//# sourceMappingURL=2.toolbox_b461b628ca4c4ba9c457.js.map