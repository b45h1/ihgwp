webpackJsonp1c6c9123_7aac_41f3_a376_3caea41ed83f_1_5_0([1],Array(41).concat([
/* 41 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
var Modal_scss_namespaceObject = {};
__webpack_require__.d(Modal_scss_namespaceObject, "duration", function() { return duration; });
__webpack_require__.d(Modal_scss_namespaceObject, "root", function() { return root; });
__webpack_require__.d(Modal_scss_namespaceObject, "rootIsVisible", function() { return rootIsVisible; });
__webpack_require__.d(Modal_scss_namespaceObject, "main", function() { return main; });

// EXTERNAL MODULE: ./lib/DeveloperTools/FBWrappers/react/index.js
var react = __webpack_require__(16);
var react_default = /*#__PURE__*/__webpack_require__.n(react);

// EXTERNAL MODULE: ./lib/DeveloperTools/FBWrappers/FakeReactDOM.js
var FakeReactDOM = __webpack_require__(17);
var FakeReactDOM_default = /*#__PURE__*/__webpack_require__.n(FakeReactDOM);

// EXTERNAL MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Utilities.js
var Utilities = __webpack_require__(43);
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Dialog/DialogContent.types.js
var DialogType;
(function (DialogType) {
    /** Standard dialog */
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/FocusTrapZone/FocusTrapZone.js



var FocusTrapZone_FocusTrapZone = /** @class */ (function (_super) {
    tslib_es6["__extends"](FocusTrapZone, _super);
    function FocusTrapZone() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this._root = Object(Utilities["createRef"])();
        ...
        _this._onKeyboardHandler = function (ev) {
            ...
            if (!_this._root.value) {
                return;
            }
            var _firstFocusableChild = Object(Utilities["getFirstFocusable"])(_this._root.value, _this._root.value.firstChild, true);
            var _lastFocusableChild = Object(Utilities["getLastTabbable"])(_this._root.value, _this._root.value.lastChild, true);
            if (ev.shiftKey && _firstFocusableChild === ev.target) {
                Object(Utilities["focusAsync"])(_lastFocusableChild);
                ev.preventDefault();
                ev.stopPropagation();
            }
            else if (!ev.shiftKey && _lastFocusableChild === ev.target) {
                Object(Utilities["focusAsync"])(_firstFocusableChild);
                ev.preventDefault();
                ev.stopPropagation();
            }
        };
    ...
    FocusTrapZone.prototype.componentDidMount = function () {
        ...
        if (!Object(Utilities["elementContains"])(this._root.value, this._previouslyFocusedElement) && !disableFirstFocus) {
            this.focus();
        }
        if (forceFocusInsideTrap) {
    ...
    FocusTrapZone.prototype.componentWillUnmount = function () {
        ...
        if (!ignoreExternalFocusing && this._previouslyFocusedElement && typeof this._previouslyFocusedElement.focus === 'function') {
            Object(Utilities["focusAsync"])(this._previouslyFocusedElement);
        }
    };
    FocusTrapZone.prototype.render = function () {
        var _a = this.props, className = _a.className, ariaLabelledBy = _a.ariaLabelledBy;
        var divProps = Object(Utilities["getNativeProps"])(this.props, Utilities["divProperties"]);
        return (react["createElement"]("div", tslib_es6["__assign"]({}, divProps, { className: className, ref: this._root, "aria-labelledby": ariaLabelledBy, onKeyDown: this._onKeyboardHandler }), this.props.children));
    };
    /**
    ...
    FocusTrapZone.prototype.focus = function () {
        ...
        if (this._root.value) {
            if (focusSelector) {
                ...
                _firstFocusableChild = Object(Utilities["getNextElement"])(this._root.value, this._root.value.firstChild, true, false, false, true);
            }
        }
    ...
    FocusTrapZone.prototype._forceFocusInTrap = function (ev) {
        if (FocusTrapZone._focusStack.length && this === FocusTrapZone._focusStack[FocusTrapZone._focusStack.length - 1]) {
            ...
            if (!Object(Utilities["elementContains"])(this._root.value, focusedElement)) {
                this.focus();
                ev.preventDefault();
                ev.stopPropagation();
            }
    ...
    FocusTrapZone.prototype._forceClickInTrap = function (ev) {
        if (FocusTrapZone._clickStack.length && this === FocusTrapZone._clickStack[FocusTrapZone._clickStack.length - 1]) {
            ...
            if (clickedElement && !Object(Utilities["elementContains"])(this._root.value, clickedElement)) {
                this.focus();
                ev.preventDefault();
                ev.stopPropagation();
            }
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/FocusTrapZone/index.js


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Overlay/Overlay.base.js



var getClassNames = Object(Utilities["classNamesFunction"])();
var Overlay_base_OverlayBase = /** @class */ (function (_super) {
    tslib_es6["__extends"](OverlayBase, _super);
    function OverlayBase() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    OverlayBase.prototype.componentDidMount = function () {
        Object(Utilities["disableBodyScroll"])();
    };
    OverlayBase.prototype.componentWillUnmount = function () {
        Object(Utilities["enableBodyScroll"])();
    };
    OverlayBase.prototype.render = function () {
        ...
        return (react["createElement"]("div", tslib_es6["__assign"]({}, divProps, { className: classNames.root })));
    };
    OverlayBase = tslib_es6["__decorate"]([
        Object(Utilities["customizable"])('Overlay', ['theme'])
    ], OverlayBase);
    return OverlayBase;
}(Utilities["BaseComponent"]));


// EXTERNAL MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Styling.js
var Styling = __webpack_require__(45);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Overlay/Overlay.styles.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Overlay/Overlay.js



var Overlay = Object(Utilities["styled"])(Overlay_base_OverlayBase, Overlay_styles_getStyles);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Overlay/index.js



// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Overlay.js


// EXTERNAL MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Layer.js + 9 modules
var Layer = __webpack_require__(95);

// EXTERNAL MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Popup/index.js + 1 modules
var Popup = __webpack_require__(99);

// EXTERNAL MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/utilities/decorators/withResponsiveMode.js
var withResponsiveMode = __webpack_require__(65);

// EXTERNAL MODULE: external "@microsoft/load-themed-styles"
var load_themed_styles_ = __webpack_require__(40);
var load_themed_styles__default = /*#__PURE__*/__webpack_require__.n(load_themed_styles_);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Modal/Modal.scss.js
/* tslint:disable */

Object(load_themed_styles_["loadStyles"])([{ "rawString": ".root_14c51ed8{background-color:transparent;position:fixed;height:100%;width:100%;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;opacity:0;pointer-events:none;-webkit-transition:opacity .267s;transition:opacity .267s}.root_14c51ed8 .ms-Button.ms-Button--compound{display:block}[dir='ltr'] .root_14c51ed8 .ms-Button.ms-Button--compound{margin-left:0}[dir='rtl'] .root_14c51ed8 .ms-Button.ms-Button--compound{margin-right:0}@media screen and (-ms-high-contrast: active){.root_14c51ed8 .ms-Overlay{opacity:0}}.rootIsVisible_14c51ed8{opacity:1;pointer-events:auto}.main_14c51ed8{background-color:" }, { "theme": "white", "defaultValue": "#ffffff" }, { "rawString": ";-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;outline:3px solid transparent;max-height:100%;overflow-y:auto}[dir='ltr'] .main_14c51ed8{-webkit-box-shadow:0 0 5px 0 rgba(0,0,0,0.4);box-shadow:0 0 5px 0 rgba(0,0,0,0.4)}[dir='rtl'] .main_14c51ed8{-webkit-box-shadow:0 0 5px 0 rgba(0,0,0,0.4);box-shadow:0 0 5px 0 rgba(0,0,0,0.4)}[dir='ltr'] .main_14c51ed8{text-align:left}[dir='rtl'] .main_14c51ed8{text-align:right}\n" }]);
var duration = ".267s";
var root = "root_14c51ed8";
var rootIsVisible = "rootIsVisible_14c51ed8";
var main = "main_14c51ed8";

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Modal/Modal.js
...
var styles = Modal_scss_namespaceObject;
var Modal_Modal = /** @class */ (function (_super) {
    tslib_es6["__extends"](Modal, _super);
    function Modal(props) {
        var _this = _super.call(this, props) || this;
        _this._focusTrapZone = Object(Utilities["createRef"])();
        _this.state = {
            id: Object(Utilities["getId"])('Modal'),
            isOpen: props.isOpen,
    ...
    Modal.prototype.render = function () {
        ...
        var modalClassName = Object(Utilities["css"])('ms-Modal', styles.root, this.props.className, !!isOpen && 'is-open', !!isVisible && styles.rootIsVisible);
        if (!isOpen) {
            return null;
        }
        // @temp tuatology - Will adjust this to be a panel at certain breakpoints
        if (responsiveMode >= withResponsiveMode["a" /* ResponsiveMode */].small) {
            return (react["createElement"](Layer["a" /* Layer */], { onLayerDidMount: onLayerDidMount },
                react["createElement"](Popup["a" /* Popup */], { role: isBlocking ? 'alertdialog' : 'dialog', ariaLabelledBy: titleAriaId, ariaDescribedBy: subtitleAriaId, onDismiss: onDismiss },
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Modal/index.js


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Modal.js



// EXTERNAL MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Button.js + 36 modules
var Button = __webpack_require__(64);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Dialog/DialogFooter.base.js



var DialogFooter_base_getClassNames = Object(Utilities["classNamesFunction"])();
var DialogFooter_base_DialogFooterBase = /** @class */ (function (_super) {
    tslib_es6["__extends"](DialogFooterBase, _super);
    ...
    DialogFooterBase.prototype.render = function () {
        ...
        this._classNames = DialogFooter_base_getClassNames(getStyles, {
            theme: theme,
            className: className
        });
    ...
    DialogFooterBase.prototype._renderChildrenAsActions = function () {
        ...
        return react["Children"].map(this.props.children, function (child) {
            return child && react["createElement"]("span", { className: _this._classNames.action }, child);
        });
    };
    DialogFooterBase = tslib_es6["__decorate"]([
        Object(Utilities["customizable"])('DialogFooter', ['theme'])
    ], DialogFooterBase);
    return DialogFooterBase;
}(Utilities["BaseComponent"]));


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Dialog/DialogFooter.styles.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Dialog/DialogFooter.js



var DialogFooter = Object(Utilities["styled"])(DialogFooter_base_DialogFooterBase, DialogFooter_styles_getStyles);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Dialog/DialogContent.base.js
...
var DialogContent_base_getClassNames = Object(Utilities["classNamesFunction"])();
var DialogContent_base_DialogContentBase = /** @class */ (function (_super) {
    tslib_es6["__extends"](DialogContentBase, _super);
    ...
    DialogContentBase.prototype.render = function () {
        ...
        var classNames = DialogContent_base_getClassNames(getStyles, {
            theme: theme,
            className: className,
        ...
        return (react["createElement"]("div", { className: classNames.content },
            react["createElement"]("div", { className: classNames.header },
                ...
                react["createElement"]("div", { className: classNames.topButton },
                    this.props.topButtonsProps.map(function (props) { return (react["createElement"](Button["c" /* IconButton */], tslib_es6["__assign"]({}, props))); }),
                    (type === DialogType.close || (showCloseButton && type !== DialogType.largeHeader)) &&
                        react["createElement"](Button["c" /* IconButton */], { className: classNames.button, iconProps: { iconName: 'Cancel' }, ariaLabel: closeButtonAriaLabel, onClick: onDismiss }))),
    ...
    DialogContentBase = tslib_es6["__decorate"]([
        Object(Utilities["customizable"])('DialogContent', ['theme']),
        withResponsiveMode["b" /* withResponsiveMode */]
    ], DialogContentBase);
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Dialog/DialogContent.styles.js
    ...
    return ({
        ...
        subText: [
            ...
            isLargeHeader ? fonts.medium : fonts.small,
            {
                ...
                lineHeight: '1.5',
                wordWrap: 'break-word',
                fontWeight: Styling["FontWeights"].semilight,
            },
        ],
        header: [
            'ms-Dialog-header',
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Dialog/DialogContent.js



var DialogContent = Object(Utilities["styled"])(DialogContent_base_DialogContentBase, DialogContent_styles_getStyles);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Dialog/Dialog.base.js
...
var Dialog_base_getClassNames = Object(Utilities["classNamesFunction"])();
...
var Dialog_base_DialogBase = /** @class */ (function (_super) {
    tslib_es6["__extends"](DialogBase, _super);
    function DialogBase(props) {
        ...
        _this._id = Object(Utilities["getId"])('Dialog');
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Dialog/Dialog.styles.js

var Dialog_styles_getStyles = function (props) {
    var className = props.className, containerClassName = props.containerClassName, _a = props.dialogDefaultMinWidth, dialogDefaultMinWidth = _a === void 0 ? '288px' : _a, _b = props.dialogDefaultMaxWidth, dialogDefaultMaxWidth = _b === void 0 ? '340px' : _b, hidden = props.hidden;
    return ({
        root: [
            'ms-Dialog',
            className,
        ...
        main: [
            {
                ...
                selectors: (_c = {},
                    _c["@media (min-width: " + Styling["ScreenWidthMinMedium"] + "px)"] = {
                        width: 'auto',
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Dialog/Dialog.js



var Dialog = Object(Utilities["styled"])(Dialog_base_DialogBase, Dialog_styles_getStyles);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Dialog/index.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Dialog.js



// EXTERNAL MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Callout.js + 10 modules
var Callout = __webpack_require__(98);

// EXTERNAL MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/@uifabric/utilities/5.27.0/react-dom@15.6.2+react@15.6.2/node_modules/@uifabric/utilities/lib/css.js
var css = __webpack_require__(96);
        ...
        return !this.state.dismissed
            ? (react["createElement"]("div", { role: 'dialog', "data-automation-id": 'debugManifestPromptDialog', "aria-labelledby": 'manifestWarningLabel' },
                react["createElement"](Dialog, { dialogContentProps: {
                    ...
                    }, isOpen: this.state.showDialog, title: this.props.title, isBlocking: true, containerClassName: debugComponents_module_scss.dialogContainer },
                    react["createElement"]("p", { className: DebugPrompt_module_scss.warningText }, DebugPrompt_resx.debugManifestLoadingWarning),
                    react["createElement"]("p", { className: DebugPrompt_module_scss.warningText }, sp_core_library_["Text"].format(DebugPrompt_resx.debugManifestLoadingWarning2, DebugPrompt_resx.debugManifestLoadingCancel)),
                    react["createElement"](DialogFooter, null,
                        react["createElement"](Button["b" /* DefaultButton */], { "data-automation-id": 'debugManifestConfirmButton', onClick: function () { return callback(true); } }, DebugPrompt_resx.debugManifestLoadingConfirm),
                        react["createElement"](Button["d" /* PrimaryButton */], { "data-automation-id": 'debugManifestCancelButton', onClick: function () { return callback(false); } },
                            react["createElement"]("div", { ref: function (calloutTarget) { return _this._calloutTarget = calloutTarget || _this._calloutTarget; } }, DebugPrompt_resx.debugManifestLoadingCancel)))),
                react["createElement"](Callout["a" /* Callout */], { className: Object(css["css"])(DebugPrompt_module_scss.callout, (_a = {}, _a[DebugPrompt_module_scss.calloutFadeIn] = !!this.state.showCallout, _a)), target: this._calloutTarget, directionalHint: 5 , gapSpace: 10 },
                    react["createElement"]("div", { className: DebugPrompt_module_scss.calloutText }, DebugPrompt_resx.debugManifestLoadingCalloutText))))
            : null; 
        var _a;
    };
    return DebugPrompt;
...
var DebugError_resx_strings = ( false) ?
    require("../../../resx-strings/en-us.json") :
    __webpack_require__(12);
/* harmony default export */ var DebugError_resx = (DebugError_resx_strings['_mraBnnuq2J9WjrAcnw9QNA']);
...
var DebugError_DebugError = (function (_super) {
    ...
    DebugError.prototype.render = function () {
        ...
        return (react["createElement"]("div", { "data-automation-id": 'debugManifestErrorDialog', role: 'dialog' },
            react["createElement"](Dialog, { isOpen: this.state.isShown, isBlocking: true, type: DialogType.largeHeader, title: this.props.title, containerClassName: debugComponents_module_scss.dialogContainer },
                react["createElement"]("p", { className: DebugError_module_scss.detailText }, this.props.errorText || DebugError_resx.debugManifestErrorDetail),
                react["createElement"]("p", { className: DebugError_module_scss.errorText }, this.props.innerError.toString()),
                react["createElement"](DialogFooter, null,
                    react["createElement"](Button["d" /* PrimaryButton */], { "data-automation-id": 'debugManifestErrorDismissButton', onClick: function () { return _this.setState({ isShown: false }); } }, DebugError_resx.debugManifestErrorDismissButtonText)))));
    };
    return DebugError;
}(react["Component"]));
...
function showDebugPrompt(options) {
    return new Promise(function (resolve) {
        ...
        FakeReactDOM["render"](react["createElement"](debugPrompt_DebugPrompt, { title: title, callback: resolve }), _ensureEmptyContainerElement());
    });
}
function showError(innerError, errorText, title) {
    if (!_errorIsShown) {
        _errorIsShown = true;
        FakeReactDOM["render"](react["createElement"](debugError_DebugError, { innerError: innerError, errorText: errorText, title: title }), _ensureEmptyContainerElement());
    }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__);
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "BaseComponent")) __webpack_require__.d(__webpack_exports__, "BaseComponent", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["BaseComponent"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "DelayedRender")) __webpack_require__.d(__webpack_exports__, "DelayedRender", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["DelayedRender"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "EventGroup")) __webpack_require__.d(__webpack_exports__, "EventGroup", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["EventGroup"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "Rectangle")) __webpack_require__.d(__webpack_exports__, "Rectangle", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["Rectangle"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "anchorProperties")) __webpack_require__.d(__webpack_exports__, "anchorProperties", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["anchorProperties"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "assign")) __webpack_require__.d(__webpack_exports__, "assign", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["assign"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "buttonProperties")) __webpack_require__.d(__webpack_exports__, "buttonProperties", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["buttonProperties"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "classNamesFunction")) __webpack_require__.d(__webpack_exports__, "classNamesFunction", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["classNamesFunction"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "createRef")) __webpack_require__.d(__webpack_exports__, "createRef", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["createRef"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "css")) __webpack_require__.d(__webpack_exports__, "css", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["css"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "customizable")) __webpack_require__.d(__webpack_exports__, "customizable", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["customizable"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "disableBodyScroll")) __webpack_require__.d(__webpack_exports__, "disableBodyScroll", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["disableBodyScroll"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "divProperties")) __webpack_require__.d(__webpack_exports__, "divProperties", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["divProperties"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "doesElementContainFocus")) __webpack_require__.d(__webpack_exports__, "doesElementContainFocus", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["doesElementContainFocus"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "elementContains")) __webpack_require__.d(__webpack_exports__, "elementContains", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["elementContains"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "enableBodyScroll")) __webpack_require__.d(__webpack_exports__, "enableBodyScroll", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["enableBodyScroll"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "findIndex")) __webpack_require__.d(__webpack_exports__, "findIndex", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["findIndex"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "findScrollableParent")) __webpack_require__.d(__webpack_exports__, "findScrollableParent", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["findScrollableParent"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "focusAsync")) __webpack_require__.d(__webpack_exports__, "focusAsync", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["focusAsync"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "focusFirstChild")) __webpack_require__.d(__webpack_exports__, "focusFirstChild", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["focusFirstChild"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "getDocument")) __webpack_require__.d(__webpack_exports__, "getDocument", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["getDocument"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "getFirstFocusable")) __webpack_require__.d(__webpack_exports__, "getFirstFocusable", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["getFirstFocusable"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "getId")) __webpack_require__.d(__webpack_exports__, "getId", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["getId"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "getLastFocusable")) __webpack_require__.d(__webpack_exports__, "getLastFocusable", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["getLastFocusable"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "getLastTabbable")) __webpack_require__.d(__webpack_exports__, "getLastTabbable", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["getLastTabbable"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "getNativeProps")) __webpack_require__.d(__webpack_exports__, "getNativeProps", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["getNativeProps"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "getNextElement")) __webpack_require__.d(__webpack_exports__, "getNextElement", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["getNextElement"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "getParent")) __webpack_require__.d(__webpack_exports__, "getParent", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["getParent"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "getPreviousElement")) __webpack_require__.d(__webpack_exports__, "getPreviousElement", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["getPreviousElement"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "getRTL")) __webpack_require__.d(__webpack_exports__, "getRTL", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["getRTL"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "getRTLSafeKeyCode")) __webpack_require__.d(__webpack_exports__, "getRTLSafeKeyCode", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["getRTLSafeKeyCode"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "getRect")) __webpack_require__.d(__webpack_exports__, "getRect", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["getRect"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "getScrollbarWidth")) __webpack_require__.d(__webpack_exports__, "getScrollbarWidth", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["getScrollbarWidth"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "getWindow")) __webpack_require__.d(__webpack_exports__, "getWindow", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["getWindow"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "hoistMethods")) __webpack_require__.d(__webpack_exports__, "hoistMethods", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["hoistMethods"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "hoistStatics")) __webpack_require__.d(__webpack_exports__, "hoistStatics", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["hoistStatics"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "htmlElementProperties")) __webpack_require__.d(__webpack_exports__, "htmlElementProperties", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["htmlElementProperties"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "imageProperties")) __webpack_require__.d(__webpack_exports__, "imageProperties", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["imageProperties"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "isElementFocusSubZone")) __webpack_require__.d(__webpack_exports__, "isElementFocusSubZone", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["isElementFocusSubZone"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "isElementFocusZone")) __webpack_require__.d(__webpack_exports__, "isElementFocusZone", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["isElementFocusZone"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "isElementTabbable")) __webpack_require__.d(__webpack_exports__, "isElementTabbable", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["isElementTabbable"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "memoizeFunction")) __webpack_require__.d(__webpack_exports__, "memoizeFunction", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["memoizeFunction"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "nullRender")) __webpack_require__.d(__webpack_exports__, "nullRender", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["nullRender"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "setVirtualParent")) __webpack_require__.d(__webpack_exports__, "setVirtualParent", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["setVirtualParent"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "shallowCompare")) __webpack_require__.d(__webpack_exports__, "shallowCompare", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["shallowCompare"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "shouldWrapFocus")) __webpack_require__.d(__webpack_exports__, "shouldWrapFocus", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["shouldWrapFocus"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "styled")) __webpack_require__.d(__webpack_exports__, "styled", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["styled"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "unhoistMethods")) __webpack_require__.d(__webpack_exports__, "unhoistMethods", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["unhoistMethods"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__, "warn")) __webpack_require__.d(__webpack_exports__, "warn", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_utilities_lib_index__["warn"]; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__ = __webpack_require__(140);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__);
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__, "AnimationClassNames")) __webpack_require__.d(__webpack_exports__, "AnimationClassNames", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__["AnimationClassNames"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__, "FontSizes")) __webpack_require__.d(__webpack_exports__, "FontSizes", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__["FontSizes"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__, "FontWeights")) __webpack_require__.d(__webpack_exports__, "FontWeights", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__["FontWeights"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__, "HighContrastSelector")) __webpack_require__.d(__webpack_exports__, "HighContrastSelector", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__["HighContrastSelector"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__, "ScreenWidthMinMedium")) __webpack_require__.d(__webpack_exports__, "ScreenWidthMinMedium", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__["ScreenWidthMinMedium"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__, "concatStyleSets")) __webpack_require__.d(__webpack_exports__, "concatStyleSets", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__["concatStyleSets"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__, "focusClear")) __webpack_require__.d(__webpack_exports__, "focusClear", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__["focusClear"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__, "getFocusStyle")) __webpack_require__.d(__webpack_exports__, "getFocusStyle", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__["getFocusStyle"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__, "getIcon")) __webpack_require__.d(__webpack_exports__, "getIcon", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__["getIcon"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__, "getIconClassName")) __webpack_require__.d(__webpack_exports__, "getIconClassName", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__["getIconClassName"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__, "getTheme")) __webpack_require__.d(__webpack_exports__, "getTheme", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__["getTheme"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__, "hiddenContentStyle")) __webpack_require__.d(__webpack_exports__, "hiddenContentStyle", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__["hiddenContentStyle"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__, "keyframes")) __webpack_require__.d(__webpack_exports__, "keyframes", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__["keyframes"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__, "mergeStyleSets")) __webpack_require__.d(__webpack_exports__, "mergeStyleSets", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__["mergeStyleSets"]; });
/* harmony namespace reexport (by used) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__, "mergeStyles")) __webpack_require__.d(__webpack_exports__, "mergeStyles", function() { return __WEBPACK_IMPORTED_MODULE_0__uifabric_styling_lib_index__["mergeStyles"]; });
...
var mergeStyles_1 = __webpack_require__(102);
exports.mergeStyles = mergeStyles_1.mergeStyles;
var mergeStyleSets_1 = __webpack_require__(107);
exports.mergeStyleSets = mergeStyleSets_1.mergeStyleSets;
var concatStyleSets_1 = __webpack_require__(69);
exports.concatStyleSets = concatStyleSets_1.concatStyleSets;
var fontFace_1 = __webpack_require__(108);
exports.fontFace = fontFace_1.fontFace;
var keyframes_1 = __webpack_require__(109);
exports.keyframes = keyframes_1.keyframes;
var Stylesheet_1 = __webpack_require__(50);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Stylesheet_1 = __webpack_require__(50);
var kebabRules_1 = __webpack_require__(103);
var prefixRules_1 = __webpack_require__(104);
var provideUnits_1 = __webpack_require__(106);
var rtlifyRules_1 = __webpack_require__(58);
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Icon/Icon.types.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Image/Image.types.js
/**
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Image/Image.base.js
...
var Image_base_ImageBase = /** @class */ (function (_super) {
    tslib_es6["__extends"](ImageBase, _super);
    function ImageBase(props) {
        ...
        _this._imageElement = Object(Utilities["createRef"])();
        _this._frameElement = Object(Utilities["createRef"])();
    ...
    ImageBase.prototype.render = function () {
        var imageProps = Object(Utilities["getNativeProps"])(this.props, Utilities["imageProperties"], ['width', 'height']);
        ...
        return (react["createElement"]("div", { className: classNames.root, style: { width: width, height: height }, ref: this._frameElement },
            react["createElement"]("img", tslib_es6["__assign"]({}, imageProps, { onLoad: this._onImageLoaded, onError: this._onImageError, key: KEY_PREFIX + this.props.src || '', className: classNames.image, ref: this._imageElement, src: src, alt: alt, role: role }))));
    };
    ImageBase.prototype._checkImageLoaded = function () {
        ...
        if (loadState === ImageLoadState.notLoaded) {
            ...
            var isLoaded = this._imageElement.value ? src && (this._imageElement.value.naturalWidth > 0 && this._imageElement.value.naturalHeight > 0) ||
                (this._imageElement.value.complete && ImageBase_1._svgRegex.test(src)) : false;
            if (isLoaded) {
    ...
    ImageBase.prototype._computeCoverStyle = function (props) {
        ...
        if ((imageFit === ImageFit.cover || imageFit === ImageFit.contain) &&
            ...
            var naturalRatio = this._imageElement.value.naturalWidth / this._imageElement.value.naturalHeight;
    ...
    ImageBase = ImageBase_1 = tslib_es6["__decorate"]([
        Object(Utilities["customizable"])('Image', ['theme'])
    ], ImageBase);
    return ImageBase;
    var ImageBase_1;
}(Utilities["BaseComponent"]));
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Image/Image.styles.js
...
var Image_styles_getStyles = function (props) {
    ...
    return ({
        ...
        image: [
            ...
            isLoaded && shouldFadeIn && !shouldStartVisible && Styling["AnimationClassNames"].fadeIn400,
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Image/Image.js



var Image = Object(Utilities["styled"])(Image_base_ImageBase, Image_styles_getStyles);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Icon/Icon.classNames.js


var Icon_classNames_getClassNames = Object(Utilities["memoizeFunction"])(function (customStyles) {
    return Object(Styling["mergeStyleSets"])({
        root: {
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Icon/Icon.base.js
...
var Icon_base_Icon = /** @class */ (function (_super) {
    tslib_es6["__extends"](Icon, _super);
    function Icon(props) {
        var _this = _super.call(this, props) || this;
    ...
    Icon.prototype.render = function () {
        ...
        var classNames = Icon_classNames_getClassNames(styles);
        ...
        if (this.props.iconType === IconType.image || this.props.iconType === IconType.Image) {
            var containerClassName = Object(Utilities["css"])('ms-Icon-imageContainer', classNames.root, classNames.imageContainer, className);
            var imageLoadError = this.state.imageLoadError;
            var imageProps = tslib_es6["__assign"]({}, this.props.imageProps, { onLoadingStateChange: this.onImageLoadingStateChange });
            var ImageType = imageLoadError && imageErrorAs || Image;
            return (react["createElement"]("div", tslib_es6["__assign"]({}, containerProps, { className: Object(Utilities["css"])(containerClassName, classNames.root) }),
                react["createElement"](ImageType, tslib_es6["__assign"]({}, imageProps))));
        }
        else if (typeof iconName === 'string' && iconName.length === 0) {
            return (react["createElement"]("i", tslib_es6["__assign"]({}, containerProps, Object(Utilities["getNativeProps"])(this.props, Utilities["htmlElementProperties"]), { className: Object(Utilities["css"])('ms-Icon-placeHolder', classNames.rootHasPlaceHolder, this.props.className) })));
        }
        else {
            var iconDefinition = Object(Styling["getIcon"])(iconName) || {
                subset: {
                    className: undefined
                },
                code: undefined
            };
            return (react["createElement"]("i", tslib_es6["__assign"]({}, containerProps, Object(Utilities["getNativeProps"])(this.props, Utilities["htmlElementProperties"]), { className: Object(Utilities["css"])(iconDefinition.subset.className, classNames.root, this.props.className) }), iconDefinition.code));
        }
    };
    return Icon;
}(Utilities["BaseComponent"]));
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Icon/index.js



// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Icon.js
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "a", function() { return Icon_base_Icon; });
...
var DefaultPalette_1 = __webpack_require__(62);
exports.DefaultPalette = DefaultPalette_1.DefaultPalette;
var DefaultFontStyles_1 = __webpack_require__(84);
...
var fonts_1 = __webpack_require__(85);
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/FocusZone/FocusZone.types.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/FocusZone/FocusZone.js
...
var FocusZone_FocusZone = /** @class */ (function (_super) {
    tslib_es6["__extends"](FocusZone, _super);
    function FocusZone(props) {
        var _this = _super.call(this, props) || this;
        _this._root = Object(Utilities["createRef"])();
        _this._onFocus = function (ev) {
            var onActiveElementChanged = _this.props.onActiveElementChanged;
            if (_this._isImmediateDescendantOfZone(ev.target)) {
                ...
                while (parentElement && parentElement !== _this._root.value) {
                    if (Object(Utilities["isElementTabbable"])(parentElement) && _this._isImmediateDescendantOfZone(parentElement)) {
                        _this._activeElement = parentElement;
                        break;
                    }
                    parentElement = Object(Utilities["getParent"])(parentElement, ALLOW_VIRTUAL_ELEMENTS);
                }
            }
        ...
        _this._onMouseDown = function (ev) {
            ...
            var path = [];
            while (target && target !== _this._root.value) {
                path.push(target);
                target = Object(Utilities["getParent"])(target, ALLOW_VIRTUAL_ELEMENTS);
            }
            while (path.length) {
                target = path.pop();
                if (target && Object(Utilities["isElementTabbable"])(target)) {
                    _this._setActiveElement(target, true);
                }
                if (Object(Utilities["isElementFocusZone"])(target)) {
        ...
        _this._onKeyDown = function (ev) {
            ...
            if (document.activeElement === _this._root.value && _this._isInnerZone) {
            ...
            if (isInnerZoneKeystroke &&
                ...
                else if (Object(Utilities["isElementFocusSubZone"])(ev.target)) {
                    if (!_this.focusElement(Object(Utilities["getNextElement"])(ev.target, ev.target.firstChild, true))) {
                        return;
                    }
                }
                else {
                ...
                switch (ev.which) {
                    ...
                    case 36 /* home */:
                        ...
                        var firstChild = _this._root.value && _this._root.value.firstChild;
                        if (_this._root.value && firstChild && _this.focusElement(Object(Utilities["getNextElement"])(_this._root.value, firstChild, true))) {
                            break;
                        }
                        return;
                    case 35 /* end */:
                        ...
                        var lastChild = _this._root.value && _this._root.value.lastChild;
                        if (_this._root.value && _this.focusElement(Object(Utilities["getPreviousElement"])(_this._root.value, lastChild, true, true, true))) {
                            break;
                        }
                        return;
                    case 13 /* enter */:
        ...
        _this._id = Object(Utilities["getId"])('FocusZone');
    ...
    FocusZone.prototype.componentDidMount = function () {
        ...
        if (this._root.value) {
            var windowElement = this._root.value.ownerDocument.defaultView;
            var parentElement = Object(Utilities["getParent"])(this._root.value, ALLOW_VIRTUAL_ELEMENTS);
            while (parentElement &&
                parentElement !== document.body &&
                parentElement.nodeType === 1) {
                if (Object(Utilities["isElementFocusZone"])(parentElement)) {
            ...
            if (this.props.defaultActiveElement) {
                this._activeElement = Object(Utilities["getDocument"])().querySelector(this.props.defaultActiveElement);
                this.focus();
            }
        }
    };
    ...
    FocusZone.prototype.render = function () {
        ...
        var divProps = Object(Utilities["getNativeProps"])(this.props, Utilities["htmlElementProperties"]);
        var Tag = this.props.elementType || 'div';
        return (react["createElement"](Tag, tslib_es6["__assign"]({ role: 'presentation' }, divProps, rootProps, { className: Object(Utilities["css"])('ms-FocusZone', className), ref: this._root, "data-focuszone-id": this._id, "aria-labelledby": ariaLabelledBy, "aria-describedby": ariaDescribedBy, onKeyDown: this._onKeyDown, onFocus: this._onFocus, onMouseDownCapture: this._onMouseDown }), this.props.children));
    };
    /**
    ...
    FocusZone.prototype.focus = function (forceIntoFirstElement) {
        ...
        if (this._root.value) {
            if (!forceIntoFirstElement && this._root.value.getAttribute(IS_FOCUSABLE_ATTRIBUTE) === 'true' && this._isInnerZone) {
                var ownerZoneElement = this._getOwnerZone(this._root.value);
            ...
            else if (!forceIntoFirstElement && this._activeElement && Object(Utilities["elementContains"])(this._root.value, this._activeElement)
                && Object(Utilities["isElementTabbable"])(this._activeElement)) {
                this._activeElement.focus();
                return true;
            }
            else {
                var firstChild = this._root.value.firstChild;
                return this.focusElement(Object(Utilities["getNextElement"])(this._root.value, firstChild, true));
            }
        }
        return false;
    };
    ...
    FocusZone.prototype._setActiveElement = function (element, forceAlignemnt) {
        ...
        if (previousActiveElement) {
            if (Object(Utilities["isElementFocusZone"])(previousActiveElement)) {
    ...
    FocusZone.prototype._tryInvokeClickForFocusable = function (target) {
        ...
        do {
            ...
            if (this._isImmediateDescendantOfZone(target) &&
                ...
                Utilities["EventGroup"].raise(target, 'click', null, true);
                return true;
            }
            target = Object(Utilities["getParent"])(target, ALLOW_VIRTUAL_ELEMENTS);
    ...
    FocusZone.prototype._getFirstInnerZone = function (rootElement) {
        ...
        if (Object(Utilities["isElementFocusZone"])(rootElement)) {
            return _allInstances[rootElement.getAttribute(FOCUSZONE_ID_ATTRIBUTE)];
        }
        var child = rootElement.firstElementChild;
        while (child) {
            if (Object(Utilities["isElementFocusZone"])(child)) {
    ...
    FocusZone.prototype._moveFocus = function (isForward, getDistanceFromCenter, ev, useDefaultWrap) {
        ...
        do {
            element = (isForward ? Object(Utilities["getNextElement"])(this._root.value, element) : Object(Utilities["getPreviousElement"])(this._root.value, element));
            if (isBidirectional) {
                if (element) {
        ...
        if (candidateElement && candidateElement !== this._activeElement) {
            ...
            if (isForward) {
                return this.focusElement(Object(Utilities["getNextElement"])(this._root.value, this._root.value.firstElementChild, true));
            }
            else {
                return this.focusElement(Object(Utilities["getPreviousElement"])(this._root.value, this._root.value.lastElementChild, true, true, true));
            }
        }
        return changedFocus;
    };
    ...
    FocusZone.prototype._moveFocusLeft = function () {
        ...
        if (this._moveFocus(Object(Utilities["getRTL"])(), function (activeRect, targetRect) {
            var distance = -1;
    ...
    FocusZone.prototype._getOwnerZone = function (element) {
        var parentElement = Object(Utilities["getParent"])(element, ALLOW_VIRTUAL_ELEMENTS);
    ...
    FocusZone.prototype._updateTabIndexes = function (element) {
        if (!element && this._root.value) {
            ...
            if (this._activeElement && !Object(Utilities["elementContains"])(element, this._activeElement)) {
                this._activeElement = null;
            }
        }
        // If active element changes state to disabled, set it to null.
        // Otherwise, we lose keyboard accessibility to other elements in focus zone.
        if (this._activeElement && !Object(Utilities["isElementTabbable"])(this._activeElement)) {
            this._activeElement = null;
        }
        ...
        for (var childIndex = 0; childNodes && childIndex < childNodes.length; childIndex++) {
            ...
            if (!Object(Utilities["isElementFocusZone"])(child)) {
                ...
                if (Object(Utilities["isElementTabbable"])(child)) {
    ...
    FocusZone.prototype._shouldWrapFocus = function (element, noWrapDataAttribute) {
        return !!this.props.checkForNoWrap ? Object(Utilities["shouldWrapFocus"])(element, noWrapDataAttribute) : true;
    };
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/FocusZone/index.js



// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/FocusZone.js
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "a", function() { return FocusZone_FocusZone; });
/* unused concated harmony import null */
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, false, function() { return FocusZoneTabbableElements; });
...
var icons_1 = __webpack_require__(83);
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(44);
var GlobalSettings_1 = __webpack_require__(61);
var EventGroup_1 = __webpack_require__(56);
...
// EXTERNAL MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Icon.js + 8 modules
var Icon = __webpack_require__(54);

// EXTERNAL MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/common/DirectionalHint.js
var DirectionalHint = __webpack_require__(94);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/ContextualMenu/ContextualMenu.types.js
...
// EXTERNAL MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/FocusZone.js + 3 modules
var FocusZone = __webpack_require__(57);

// EXTERNAL MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Styling.js
var Styling = __webpack_require__(45);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/ContextualMenu/ContextualMenu.styles.js



var ContextualMenuItemHeight = '32px';
var getItemHighContrastStyles = Object(Utilities["memoizeFunction"])(function () {
    return {
        selectors: (_a = {},
            _a[Styling["HighContrastSelector"]] = {
...
var getMenuItemStyles = Object(Utilities["memoizeFunction"])(function (theme) {
    ...
    var menuItemStyles = {
        ...
        rootHovered: tslib_es6["__assign"]({ backgroundColor: ContextualMenuItemBackgroundHoverColor }, getItemHighContrastStyles()),
        rootFocused: tslib_es6["__assign"]({ backgroundColor: ContextualMenuItemBackgroundHoverColor }, getItemHighContrastStyles()),
        rootChecked: tslib_es6["__assign"]({}, getItemHighContrastStyles()),
        rootPressed: tslib_es6["__assign"]({ backgroundColor: ContextualMenuItemBackgroundSelectedColor }, getItemHighContrastStyles()),
        rootExpanded: tslib_es6["__assign"]({ backgroundColor: ContextualMenuItemBackgroundSelectedColor, color: semanticColors.bodyTextChecked }, getItemHighContrastStyles()),
        linkContent: {
            whiteSpace: 'nowrap',
            height: 'inherit',
            display: 'flex',
        ...
        subMenuIcon: {
            ...
            verticalAlign: 'middle',
            flexShrink: '0',
            fontSize: Styling["FontSizes"].mini
        },
    ...
    return Object(Styling["concatStyleSets"])(menuItemStyles);
    var _a, _b, _c, _d;
});
var getStyles = Object(Utilities["memoizeFunction"])(function (theme) {
    var semanticColors = theme.semanticColors, fonts = theme.fonts;
    ...
    var styles = {
        ...
        header: [
            fonts.small,
            {
                fontWeight: Styling["FontWeights"].semibold,
    ...
    return Object(Styling["concatStyleSets"])(styles);
});

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Divider/VerticalDivider.classNames.js


var getDividerClassNames = Object(Utilities["memoizeFunction"])(function (theme) {
    return Object(Styling["mergeStyleSets"])({
        wrapper: {
            display: 'inline-flex',
            height: '100%',
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/ContextualMenu/ContextualMenu.classNames.js




var getSplitButtonVerticalDividerClassNames = Object(Utilities["memoizeFunction"])(function (theme) {
    return Object(Styling["mergeStyleSets"])(getDividerClassNames(theme), {
        divider: {
            height: 16,
            width: 1,
        }
...
var getContextualMenuClassNames = Object(Utilities["memoizeFunction"])(function (theme, className) {
...
var getItemClassNames = Object(Utilities["memoizeFunction"])(function (theme, disabled, expanded, checked, isAnchorLink, knownIcon, itemClassName, dividerClassName, iconClassName, subMenuClassName) {
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/utilities/contextualMenu/contextualMenuUtility.js
/**
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/utilities/contextualMenu/index.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Divider/VerticalDivider.js



var VerticalDivider = function (props) {
    var theme = Object(Styling["getTheme"])();
    var classNames = props.getClassNames ? props.getClassNames(theme) : getDividerClassNames(theme);
    return (react["createElement"]("span", { className: classNames.wrapper },
        react["createElement"]("span", { className: classNames.divider })));
};

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Divider/index.js


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Divider.js


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/ContextualMenu/ContextualMenuItem.js
...
var renderItemIcon = function (_a) {
    ...
    if (iconProps) {
        return react["createElement"](Icon["a" /* Icon */], tslib_es6["__assign"]({}, iconProps, { className: classNames.icon }));
    }
    return react["createElement"](Icon["a" /* Icon */], { iconName: icon, className: classNames.icon });
};
var renderCheckMarkIcon = function (_a) {
    ...
    if (onCheckmarkClick) {
        ...
        return (react["createElement"](Icon["a" /* Icon */], { iconName: isItemChecked ? 'CheckMark' : '', className: classNames.checkmarkIcon, onClick: onClick }));
    }
    return null;
};
...
var renderSubMenuIcon = function (_a) {
    var item = _a.item, classNames = _a.classNames;
    if (hasSubmenu(item)) {
        return (react["createElement"](Icon["a" /* Icon */], tslib_es6["__assign"]({ iconName: Object(Utilities["getRTL"])() ? 'ChevronLeft' : 'ChevronRight' }, item.submenuIconProps, { className: classNames.subMenuIcon })));
    }
    return null;
};
var ContextualMenuItem = function (props) {
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/ContextualMenu/ContextualMenu.js
...
var ContextualMenu_ContextualMenu = /** @class */ (function (_super) {
    tslib_es6["__extends"](ContextualMenu, _super);
    function ContextualMenu(props) {
        var _this = _super.call(this, props) || this;
        _this._navigationIdleDelay = 250 /* ms */;
        ...
        _this._shouldCloseSubMenu = function (ev) {
            var submenuCloseKey = Object(Utilities["getRTL"])() ? 39 /* right */ : 37 /* left */;
            ...
            return _this._adjustedFocusZoneProps.direction === FocusZone["b" /* FocusZoneDirection */].vertical ||
                (!!_this._adjustedFocusZoneProps.checkForNoWrap && !Object(Utilities["shouldWrapFocus"])(ev.target, 'data-no-horizontal-wrap'));
        };
        _this._onMenuKeyDown = function (ev) {
            ...
            var elementToFocus = ev.which === 38 /* up */ ?
                Object(Utilities["getLastFocusable"])(_this._host, _this._host.lastChild, true) :
                ev.which === 40 /* down */ ?
                    Object(Utilities["getFirstFocusable"])(_this._host, _this._host.firstChild, true) :
                    null;
            if (elementToFocus) {
        ...
        _this._onScroll = function () {
            ...
            _this._scrollIdleTimeoutId = _this._async.setTimeout(function () { _this._isScrollIdle = true; }, _this._navigationIdleDelay);
        };
        ...
        _this.state = {
            ...
            subMenuId: Object(Utilities["getId"])('ContextualMenu')
        };
        _this._warnDeprecations({
            'targetPoint': 'target',
        ...
        _this._splitButtonContainers = new Map();
        return _this;
    }
    ...
    ContextualMenu.prototype.render = function () {
        ...
        this._adjustedFocusZoneProps = tslib_es6["__assign"]({}, focusZoneProps, { direction: this._getFocusZoneDirection() });
        ...
        if (items && items.length > 0) {
            ...
            return (react["createElement"](Callout["a" /* Callout */], tslib_es6["__assign"]({}, calloutProps, { target: useTargetPoint ? targetPoint : target, isBeakVisible: isBeakVisible, beakWidth: beakWidth, directionalHint: directionalHint, directionalHintForRTL: directionalHintForRTL, gapSpace: gapSpace, coverTarget: coverTarget, doNotLayer: doNotLayer, className: Object(Utilities["css"])('ms-ContextualMenu-Callout', calloutProps ? calloutProps.className : undefined), setInitialFocus: shouldFocusOnMount, onDismiss: this.props.onDismiss, onScroll: this._onScroll, bounds: bounds, directionalHintFixed: directionalHintFixed, hidden: this.props.hidden }),
                react["createElement"]("div", { role: 'menu', "aria-label": ariaLabel, "aria-labelledby": labelElementId, style: contextMenuStyle, ref: function (host) { return _this._host = host; }, id: id, className: this._classNames.container, tabIndex: 0, onKeyDown: this._onMenuKeyDown },
                    title && react["createElement"]("div", { className: this._classNames.title, role: 'heading', "aria-level": 1 },
                        ...
                        title,
                        " "),
                    (items && items.length) ? (react["createElement"](FocusZone["a" /* FocusZone */], tslib_es6["__assign"]({}, this._adjustedFocusZoneProps, { className: this._classNames.root, isCircularNavigation: true, handleTabKey: 1 /* all */ }),
    ...
    ContextualMenu.prototype._getFocusZoneDirection = function () {
        ...
        return arrowDirection !== undefined ? arrowDirection :
            focusZoneProps && focusZoneProps.direction !== undefined ? focusZoneProps.direction : FocusZone["b" /* FocusZoneDirection */].vertical;
    };
    ContextualMenu.prototype._onRenderSubMenu = function (subMenuProps) {
        return react["createElement"](ContextualMenu_1, tslib_es6["__assign"]({}, subMenuProps));
    };
    ...
    ContextualMenu.prototype._renderNormalItem = function (item, classNames, index, focusableElementIndex, totalItemCount, hasCheckmarks, hasIcons) {
        if (item.onRender) {
            return [item.onRender(tslib_es6["__assign"]({ 'aria-posinset': focusableElementIndex + 1, 'aria-setsize': totalItemCount }, item), this.dismiss)];
        }
        if (item.href) {
    ...
    ContextualMenu.prototype._renderAnchorMenuItem = function (item, classNames, index, focusableElementIndex, totalItemCount, hasCheckmarks, hasIcons) {
        ...
        return (react["createElement"]("div", null,
            react["createElement"]("a", tslib_es6["__assign"]({}, Object(Utilities["getNativeProps"])(item, Utilities["anchorProperties"]), { href: item.href, target: item.target, rel: anchorRel, className: classNames.root, role: 'menuitem', "aria-owns": item.key === expandedMenuItemKey ? subMenuId : undefined, "aria-haspopup": itemHasSubmenu || undefined, "aria-expanded": itemHasSubmenu ? item.key === expandedMenuItemKey : undefined, "aria-posinset": focusableElementIndex + 1, "aria-setsize": totalItemCount, "aria-disabled": this._isItemDisabled(item), style: item.style, onClick: this._onAnchorClick.bind(this, item), onMouseEnter: this._onItemMouseEnter.bind(this, item), onMouseLeave: this._onMouseItemLeave.bind(this, item), onKeyDown: itemHasSubmenu ? this._onItemKeyDown.bind(this, item) : null }),
                react["createElement"](ChildrenRenderer, { item: item, classNames: classNames, index: index, onCheckmarkClick: hasCheckmarks ? this._onItemClick : undefined, hasIcons: hasIcons }))));
    };
    ContextualMenu.prototype._renderButtonItem = function (item, classNames, index, focusableElementIndex, totalItemCount, hasCheckmarks, hasIcons) {
        ...
        var itemHasSubmenu = hasSubmenu(item);
        var buttonNativeProperties = Object(Utilities["getNativeProps"])(item, Utilities["buttonProperties"]);
        ...
        return (react["createElement"]("button", tslib_es6["__assign"]({}, buttonNativeProperties, itemButtonProperties),
            react["createElement"](ChildrenRenderer, { item: item, classNames: classNames, index: index, onCheckmarkClick: hasCheckmarks ? this._onItemClick : undefined, hasIcons: hasIcons })));
    };
    ContextualMenu.prototype._renderSplitButton = function (item, classNames, index, focusableElementIndex, totalItemCount, hasCheckmarks, hasIcons) {
        ...
        return (react["createElement"]("div", { ref: function (el) {
                return _this._splitButtonContainers.set(item.key, el);
            }, role: 'button', "aria-labelledby": item.ariaLabel, className: classNames.splitContainer, "aria-disabled": this._isItemDisabled(item), "aria-haspopup": true, "aria-describedby": item.ariaDescription, "aria-checked": item.isChecked || item.checked, "aria-posinset": focusableElementIndex + 1, "aria-setsize": totalItemCount, onMouseEnter: this._onItemMouseEnter.bind(this, tslib_es6["__assign"]({}, item, { subMenuProps: null, items: null })), onMouseLeave: this._onMouseItemLeave.bind(this, tslib_es6["__assign"]({}, item, { subMenuProps: null, items: null })), onMouseMove: this._onItemMouseMove.bind(this, tslib_es6["__assign"]({}, item, { subMenuProps: null, items: null })), onKeyDown: this._onSplitContainerItemKeyDown.bind(this, item), onClick: this._executeItemClick.bind(this, item), tabIndex: 0, "data-is-focusable": true },
    ...
    ContextualMenu.prototype._renderSplitPrimaryButton = function (item, classNames, index, hasCheckmarks, hasIcons) {
        ...
        return react["createElement"]('button', Object(Utilities["getNativeProps"])(itemProps, Utilities["buttonProperties"]), react["createElement"](ChildrenRenderer, { item: itemProps, classNames: classNames, index: index, onCheckmarkClick: hasCheckmarks ? this._onItemClick : undefined, hasIcons: hasIcons }));
    };
    ContextualMenu.prototype._onSplitContainerItemKeyDown = function (item, ev) {
    ...
    ContextualMenu.prototype._renderSplitIconButton = function (item, classNames, index) {
        ...
        return react["createElement"]('button', Object(Utilities["assign"])({}, Object(Utilities["getNativeProps"])(itemProps, Utilities["buttonProperties"]), {
            onMouseEnter: this._onItemMouseEnter.bind(this, item),
            onMouseLeave: this._onMouseItemLeave.bind(this, item),
            onMouseDown: function (ev) { return _this._onItemMouseDown(item, ev); },
            onMouseMove: this._onItemMouseMove.bind(this, item),
     ...
     */
    ContextualMenu.prototype._updateFocusOnMouseEvent = function (item, ev) {
        var _this = this;
        var targetElement = ev.currentTarget;
        var _a = this.props.subMenuHoverDelay, timeoutDuration = _a === void 0 ? this._navigationIdleDelay : _a;
        ...
        if (hasSubmenu(item)) {
            ...
            this._enterTimerId = this._async.setTimeout(function () {
                targetElement.focus();
                var splitButtonContainer = _this._splitButtonContainers.get(item.key);
                _this._onItemSubMenuExpand(item, ((item.split && splitButtonContainer) ? splitButtonContainer : targetElement));
                _this._enterTimerId = undefined;
    ...
    ContextualMenu.prototype._onSplitItemClick = function (item, ev) {
        var splitButtonContainer = this._splitButtonContainers.get(item.key);
        // get the whole splitButton container to base the menu off of
        this._onItemClickBase(item, ev, (splitButtonContainer ? splitButtonContainer : ev.currentTarget));
    };
    ContextualMenu.prototype._onItemClickBase = function (item, ev, target) {
    ...
    ContextualMenu.prototype._onItemKeyDown = function (item, ev) {
        var openKey = Object(Utilities["getRTL"])() ? 37 /* left */ : 39 /* right */;
    ...
    ContextualMenu.prototype._getSubmenuProps = function () {
        ...
        if (item) {
            submenuProps = {
                ...
                directionalHint: Object(Utilities["getRTL"])() ? 8 /* leftTopEdge */ : 11 /* rightTopEdge */,
                className: this.props.className,
                gapSpace: 0,
                isBeakVisible: false
            };
            if (item.subMenuProps) {
                Object(Utilities["assign"])(submenuProps, item.subMenuProps);
            }
        }
        return submenuProps;
    };
    ...
    ContextualMenu.prototype._setTargetWindowAndElement = function (target) {
        if (target) {
            if (typeof target === 'string') {
                var currentDoc = Object(Utilities["getDocument"])();
                this._target = currentDoc ? currentDoc.querySelector(target) : null;
                this._targetWindow = Object(Utilities["getWindow"])();
            }
            else if (target.stopPropagation) {
                this._targetWindow = Object(Utilities["getWindow"])(target.toElement);
                this._target = target;
            }
                ...
                this._targetWindow = Object(Utilities["getWindow"])(targetElement);
                this._target = target;
            }
        }
        else {
    ...
    ContextualMenu.prototype._getSubMenuId = function (item) {
    ...
    ContextualMenu = ContextualMenu_1 = tslib_es6["__decorate"]([
        Object(Utilities["customizable"])('ContextualMenu', ['theme']),
        withResponsiveMode["b" /* withResponsiveMode */]
    ], ContextualMenu);
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/ContextualMenu/index.js




// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/ContextualMenu.js


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/BaseButton.classNames.js


var getBaseButtonClassNames = Object(Utilities["memoizeFunction"])(function (styles, className, variantClassName, iconClassName, menuIconClassName, disabled, checked, expanded, isSplit) {
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/SplitButton/SplitButton.classNames.js


var SplitButton_classNames_getClassNames = Object(Utilities["memoizeFunction"])(function (styles, disabled, expanded, checked) {
    return {
        root: Object(Styling["mergeStyles"])(styles.splitButtonMenuButton, expanded && [
        ...
        splitButtonContainer: Object(Styling["mergeStyles"])(styles.splitButtonContainer, checked && !disabled && [
        ...
        icon: Object(Styling["mergeStyles"])(styles.splitButtonMenuIcon, disabled && styles.splitButtonMenuIconDisabled),
        flexContainer: Object(Styling["mergeStyles"])(styles.splitButtonFlexContainer),
        divider: Object(Styling["mergeStyles"])(styles.splitButtonDivider)
    };
});

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/BaseButton.js
...
var BaseButton_BaseButton = /** @class */ (function (_super) {
    tslib_es6["__extends"](BaseButton, _super);
    function BaseButton(props, rootClassName) {
        var _this = _super.call(this, props) || this;
        _this._buttonElement = Object(Utilities["createRef"])();
        _this._splitButtonContainer = Object(Utilities["createRef"])();
        _this._onRenderIcon = function (buttonProps, defaultRender) {
            var iconProps = _this.props.iconProps;
            if (iconProps) {
                return (react["createElement"](Icon["a" /* Icon */], tslib_es6["__assign"]({}, iconProps, { className: _this._classNames.icon })));
            }
            return null;
        };
        _this._onRenderTextContents = function () {
            var _a = _this.props, text = _a.text, children = _a.children, description = _a.description, _b = _a.onRenderText, onRenderText = _b === void 0 ? _this._onRenderText : _b, _c = _a.onRenderDescription, onRenderDescription = _c === void 0 ? _this._onRenderDescription : _c;
        ...
        _this._onRenderDescription = function (props) {
            ...
            return description ? (react["createElement"]("div", { key: _this._descriptionId, className: _this._classNames.description, id: _this._descriptionId }, description)) : (null);
        };
        ...
        _this._onRenderMenuIcon = function (props) {
            ...
            return (react["createElement"](Icon["a" /* Icon */], tslib_es6["__assign"]({ iconName: 'ChevronDown' }, menuIconProps, { className: _this._classNames.menuIcon })));
        };
        _this._onRenderMenu = function (menuProps) {
            var _a = menuProps.onDismiss, onDismiss = _a === void 0 ? _this._dismissMenu : _a;
            return (react["createElement"](ContextualMenu_ContextualMenu, tslib_es6["__assign"]({ id: _this._labelId + '-menu', directionalHint: 4 /* bottomLeftEdge */ }, menuProps, { className: 'ms-BaseButton-menuhost ' + menuProps.className, target: _this._isSplitButton ? _this._splitButtonContainer.value : _this._buttonElement.value, labelElementId: _this._labelId, onDismiss: onDismiss })));
        };
        ...
        _this._onToggleMenu = function () {
            if (_this._splitButtonContainer.value) {
                _this._splitButtonContainer.value.focus();
            }
            var menuProps = _this.props.menuProps;
            var currentMenuProps = _this.state.menuProps;
            if (_this.props.persistMenu) {
                currentMenuProps && currentMenuProps.hidden ? _this._openMenu() : _this._dismissMenu();
            }
            else {
                currentMenuProps ? _this._dismissMenu() : _this._openMenu();
            }
        };
        ...
        _this._onSplitButtonContainerKeyDown = function (ev) {
            if (ev.which === 13 /* enter */) {
                if (_this._buttonElement.value) {
                    _this._buttonElement.value.click();
                    ev.preventDefault();
                    ev.stopPropagation();
                }
            }
        ...
        _this._labelId = Object(Utilities["getId"])();
        _this._descriptionId = Object(Utilities["getId"])();
        _this._ariaDescriptionId = Object(Utilities["getId"])();
        var menuProps = null;
    ...
    BaseButton.prototype.render = function () {
        ...
        this._classNames = getClassNames ? getClassNames(theme, className, variantClassName, iconProps && iconProps.className, menuIconProps && menuIconProps.className, isPrimaryButtonDisabled, checked, !!menuProps, this.props.split) : getBaseButtonClassNames(styles, className, variantClassName, iconProps && iconProps.className, menuIconProps && menuIconProps.className, isPrimaryButtonDisabled, checked, !!menuProps, this.props.split);
        ...
        var nativeProps = Object(Utilities["getNativeProps"])(Object(Utilities["assign"])(renderAsAnchor ? {} : { type: 'button' }, this.props.rootProps, this.props), renderAsAnchor ? Utilities["anchorProperties"] : Utilities["buttonProperties"], [
        ...
        var buttonProps = Object(Utilities["assign"])(nativeProps, {
        ...
        if (this._isSplitButton) {
            ...
            Object(Utilities["assign"])(buttonProps, {
    ...
    BaseButton.prototype._onRenderContent = function (tag, buttonProps) {
        ...
        var Content = (react["createElement"](Tag, tslib_es6["__assign"]({}, buttonProps),
    ...
    BaseButton.prototype._onRenderSplitButtonContent = function (tag, buttonProps) {
        ...
        var classNames = getSplitButtonClassNames ? getSplitButtonClassNames(!!disabled, !!this.state.menuProps, !!checked) : styles && SplitButton_classNames_getClassNames(styles, !!disabled, !!this.state.menuProps, !!checked);
        Object(Utilities["assign"])(buttonProps, {
            onClick: undefined,
            tabIndex: -1,
            'data-is-focusable': false
        });
        return (react["createElement"]("div", { role: 'button', "aria-labelledby": buttonProps.ariaLabel, "aria-disabled": disabled, "aria-haspopup": true, "aria-expanded": this._isExpanded, "aria-pressed": this.props.checked, "aria-describedby": buttonProps.ariaDescription, className: classNames && classNames.splitButtonContainer, onKeyDown: this._onSplitButtonContainerKeyDown, ref: this._splitButtonContainer, "data-is-focusable": true, onClick: !disabled && !primaryDisabled ? this._onSplitButtonPrimaryClick : undefined, tabIndex: !disabled ? 0 : undefined },
    ...
    BaseButton.prototype._onRenderSplitButtonMenuButton = function (classNames) {
        ...
        return react["createElement"](BaseButton, tslib_es6["__assign"]({}, splitButtonProps, { onMouseDown: this._onMouseDown, tabIndex: -1 }));
    };
    /**
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/Button.types.js
var ElementType;
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/BaseButton.styles.js
...
var iconStyle = {
    fontSize: Styling["FontSizes"].icon,
    margin: '0 4px',
    height: '16px',
    lineHeight: '16px',
    textAlign: 'center',
 ...
 */
var BaseButton_styles_getStyles = Object(Utilities["memoizeFunction"])(function (theme) {
    ...
    return {
        root: [
            Object(Styling["getFocusStyle"])(theme, -1, 'relative', buttonHighContrastFocus),
            theme.fonts.medium,
            {
                boxSizing: 'border-box',
        ...
        menuIcon: [
            iconStyle,
            {
                fontSize: Styling["FontSizes"].small
            }
        ],
        label: {
            margin: '0 4px',
        ...
        screenReaderText: Styling["hiddenContentStyle"]
    };
});

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/SplitButton/SplitButton.styles.js


var SplitButton_styles_getStyles = Object(Utilities["memoizeFunction"])(function (theme, customStyles) {
    var buttonHighContrastFocus = {
        left: -2,
        top: -2,
        bottom: -2,
    ...
    var splitButtonStyles = {
        splitButtonContainer: [
            Object(Styling["getFocusStyle"])(theme, 0, 'relative', buttonHighContrastFocus),
            {
                display: 'inline-block'
            }
        ],
    ...
    return Object(Styling["concatStyleSets"])(splitButtonStyles, customStyles);
});

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/ButtonThemes.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/DefaultButton/DefaultButton.styles.js
...
var DefaultButton_styles_getStyles = Object(Utilities["memoizeFunction"])(function (theme, customStyles, primary) {
    ...
    return Object(Styling["concatStyleSets"])(baseButtonStyles, defaultButtonStyles, primary ? primaryStyles(theme) : standardStyles(theme), splitButtonStyles, customStyles);
});

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/DefaultButton/DefaultButton.js
...
var DefaultButton_DefaultButton = /** @class */ (function (_super) {
    tslib_es6["__extends"](DefaultButton, _super);
    ...
    DefaultButton.prototype.render = function () {
        ...
        return (react["createElement"](BaseButton_BaseButton, tslib_es6["__assign"]({}, this.props, { variantClassName: primary ? 'ms-Button--primary' : 'ms-Button--default', styles: DefaultButton_styles_getStyles(theme, styles, primary), onRenderDescription: Utilities["nullRender"] })));
    };
    DefaultButton = tslib_es6["__decorate"]([
        Object(Utilities["customizable"])('DefaultButton', ['theme'])
    ], DefaultButton);
    return DefaultButton;
}(Utilities["BaseComponent"]));


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/ActionButton/ActionButton.styles.js



var ActionButton_styles_DEFAULT_BUTTON_HEIGHT = '40px';
var DEFAULT_PADDING = '0 4px';
var ActionButton_styles_getStyles = Object(Utilities["memoizeFunction"])(function (theme, customStyles) {
    var baseButtonStyles = BaseButton_styles_getStyles(theme);
    ...
    return Object(Styling["concatStyleSets"])(baseButtonStyles, actionButtonStyles, customStyles);
});

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/ActionButton/ActionButton.js
...
var ActionButton_ActionButton = /** @class */ (function (_super) {
    tslib_es6["__extends"](ActionButton, _super);
    ...
    ActionButton.prototype.render = function () {
        ...
        return (react["createElement"](BaseButton_BaseButton, tslib_es6["__assign"]({}, this.props, { variantClassName: 'ms-Button--action ms-Button--command', styles: ActionButton_styles_getStyles(theme, styles), onRenderDescription: Utilities["nullRender"] })));
    };
    ActionButton = tslib_es6["__decorate"]([
        Object(Utilities["customizable"])('ActionButton', ['theme'])
    ], ActionButton);
    return ActionButton;
}(Utilities["BaseComponent"]));


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/CompoundButton/CompoundButton.styles.js





var CompoundButton_styles_getStyles = Object(Utilities["memoizeFunction"])(function (theme, customStyles, primary) {
    var baseButtonStyles = BaseButton_styles_getStyles(theme);
    var splitButtonStyles = SplitButton_styles_getStyles(theme);
    ...
    return Object(Styling["concatStyleSets"])(baseButtonStyles, compoundButtonStyles, primary ? primaryStyles(theme) : standardStyles(theme), primary ? primaryCompoundTheme : standardCompoundTheme, splitButtonStyles, customStyles);
    var _a, _b;
});

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/CompoundButton/CompoundButton.js
...
var CompoundButton_CompoundButton = /** @class */ (function (_super) {
    tslib_es6["__extends"](CompoundButton, _super);
    ...
    CompoundButton.prototype.render = function () {
        var _a = this.props, _b = _a.primary, primary = _b === void 0 ? false : _b, styles = _a.styles, theme = _a.theme;
        return (react["createElement"](BaseButton_BaseButton, tslib_es6["__assign"]({}, this.props, { variantClassName: primary ? 'ms-Button--compoundPrimary' : 'ms-Button--compound', styles: CompoundButton_styles_getStyles(theme, styles, primary) })));
    };
    CompoundButton = tslib_es6["__decorate"]([
        Object(Utilities["customizable"])('CompoundButton', ['theme'])
    ], CompoundButton);
    return CompoundButton;
}(Utilities["BaseComponent"]));


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/IconButton/IconButton.styles.js




var IconButton_styles_getStyles = Object(Utilities["memoizeFunction"])(function (theme, customStyles) {
    var baseButtonStyles = BaseButton_styles_getStyles(theme);
    var splitButtonStyles = SplitButton_styles_getStyles(theme);
    ...
    return Object(Styling["concatStyleSets"])(baseButtonStyles, iconButtonStyles, splitButtonStyles, customStyles);
});

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/IconButton/IconButton.js
...
var IconButton_IconButton = /** @class */ (function (_super) {
    tslib_es6["__extends"](IconButton, _super);
    function IconButton() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        /**
         * Tell BaseComponent to bypass resolution of componentRef.
    ...
    IconButton.prototype.render = function () {
        var _a = this.props, styles = _a.styles, theme = _a.theme;
        return (react["createElement"](BaseButton_BaseButton, tslib_es6["__assign"]({}, this.props, { variantClassName: 'ms-Button--icon', styles: IconButton_styles_getStyles(theme, styles), onRenderText: Utilities["nullRender"], onRenderDescription: Utilities["nullRender"] })));
    };
    IconButton = tslib_es6["__decorate"]([
        Object(Utilities["customizable"])('IconButton', ['theme'])
    ], IconButton);
    return IconButton;
}(Utilities["BaseComponent"]));


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/PrimaryButton/PrimaryButton.js




var PrimaryButton_PrimaryButton = /** @class */ (function (_super) {
    tslib_es6["__extends"](PrimaryButton, _super);
    ...
    PrimaryButton.prototype.render = function () {
        return (react["createElement"](DefaultButton_DefaultButton, tslib_es6["__assign"]({}, this.props, { primary: true, onRenderDescription: Utilities["nullRender"] })));
    };
    PrimaryButton = tslib_es6["__decorate"]([
        Object(Utilities["customizable"])('PrimaryButton', ['theme'])
    ], PrimaryButton);
    return PrimaryButton;
}(Utilities["BaseComponent"]));


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/Button.js
...
var Button_Button = /** @class */ (function (_super) {
    ...
    function Button(props) {
         ...
         */
        _this._shouldUpdateComponentRef = false;
        Object(Utilities["warn"])("The Button component has been deprecated. Use specific variants instead. " +
    ...
    Button.prototype.render = function () {
        ...
        switch (props.buttonType) {
            case ButtonType.command:
                return react["createElement"](ActionButton_ActionButton, tslib_es6["__assign"]({}, props));
            case ButtonType.compound:
                return react["createElement"](CompoundButton_CompoundButton, tslib_es6["__assign"]({}, props));
            case ButtonType.icon:
                return react["createElement"](IconButton_IconButton, tslib_es6["__assign"]({}, props));
            case ButtonType.primary:
                return react["createElement"](PrimaryButton_PrimaryButton, tslib_es6["__assign"]({}, props));
            default:
                return react["createElement"](DefaultButton_DefaultButton, tslib_es6["__assign"]({}, props));
        }
    };
    return Button;
}(Utilities["BaseComponent"]));
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/CommandBarButton/CommandBarButton.styles.js




var CommandBarButton_styles_getStyles = Object(Utilities["memoizeFunction"])(function (theme, customStyles, focusInset, focusColor) {
    var baseButtonStyles = BaseButton_styles_getStyles(theme);
    ...
    var commandButtonStyles = {
        root: [
            Object(Styling["getFocusStyle"])(theme, -1, 'relative', commandButtonHighContrastFocus),
            {
                minWidth: '40px',
                backgroundColor: theme.palette.neutralLighter,
                color: theme.palette.neutralPrimary,
    ...
    return Object(Styling["concatStyleSets"])(baseButtonStyles, commandButtonStyles, baseSplitButtonStyles, customStyles);
    var _a;
});

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/CommandBarButton/CommandBarButton.js
...
var CommandBarButton_CommandBarButton = /** @class */ (function (_super) {
    tslib_es6["__extends"](CommandBarButton, _super);
    ...
    CommandBarButton.prototype.render = function () {
        var _a = this.props, styles = _a.styles, theme = _a.theme;
        return (react["createElement"](BaseButton_BaseButton, tslib_es6["__assign"]({}, this.props, { variantClassName: 'ms-Button--commandBar', styles: CommandBarButton_styles_getStyles(theme, styles), onRenderDescription: Utilities["nullRender"] })));
    };
    CommandBarButton = tslib_es6["__decorate"]([
        Object(Utilities["customizable"])('CommandBarButton', ['theme'])
    ], CommandBarButton);
    return CommandBarButton;
}(Utilities["BaseComponent"]));


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/CommandButton/CommandButton.js

var CommandButton = ActionButton_ActionButton;

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/MessageBarButton/MessageBarButton.styles.js



var MessageBarButton_styles_getStyles = Object(Utilities["memoizeFunction"])(function (theme, customStyles, focusInset, focusColor) {
    var baseButtonStyles = BaseButton_styles_getStyles(theme);
    ...
    return Object(Styling["concatStyleSets"])(baseButtonStyles, messageBarButtonStyles, customStyles);
});

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/MessageBarButton/MessageBarButton.js
...
var MessageBarButton_MessageBarButton = /** @class */ (function (_super) {
    tslib_es6["__extends"](MessageBarButton, _super);
    function MessageBarButton() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    MessageBarButton.prototype.render = function () {
        var _a = this.props, styles = _a.styles, theme = _a.theme;
        return (react["createElement"](DefaultButton_DefaultButton, tslib_es6["__assign"]({}, this.props, { styles: MessageBarButton_styles_getStyles(theme, styles), onRenderDescription: Utilities["nullRender"] })));
    };
    MessageBarButton = tslib_es6["__decorate"]([
        Object(Utilities["customizable"])('MessageBarButton', ['theme'])
    ], MessageBarButton);
    return MessageBarButton;
}(Utilities["BaseComponent"]));


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Button/index.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Button.js
/* unused concated harmony import null */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__BaseDecorator__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Utilities__ = __webpack_require__(43);
...
function withResponsiveMode(ComposedComponent) {
    var resultClass = /** @class */ (function (_super) {
        __WEBPACK_IMPORTED_MODULE_0_tslib__["__extends"](WithResponsiveMode, _super);
        ...
        WithResponsiveMode.prototype.render = function () {
            ...
            return (__WEBPACK_IMPORTED_MODULE_1_react__["createElement"](ComposedComponent, __WEBPACK_IMPORTED_MODULE_0_tslib__["__assign"]({ ref: this._updateComposedComponentRef, responsiveMode: responsiveMode }, this.props)));
        };
        WithResponsiveMode.prototype._getResponsiveMode = function () {
            var responsiveMode = ResponsiveMode.small;
            var win = Object(__WEBPACK_IMPORTED_MODULE_3__Utilities__["getWindow"])();
    ...
    return Object(__WEBPACK_IMPORTED_MODULE_3__Utilities__["hoistStatics"])(ComposedComponent, resultClass);
}
...
Object.defineProperty(exports, "__esModule", { value: true });
var dom_1 = __webpack_require__(47);
...
var tslib_1 = __webpack_require__(44);
var React = __webpack_require__(16);
var Async_1 = __webpack_require__(66);
var EventGroup_1 = __webpack_require__(51);
var warn_1 = __webpack_require__(71);
var initializeFocusRects_1 = __webpack_require__(72);
var initializeDir_1 = __webpack_require__(110);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(44);
var GlobalSettings_1 = __webpack_require__(74);
var EventGroup_1 = __webpack_require__(51);
var CustomizationsGlobalKey = 'customizations';
var NO_CUSTOMIZATIONS = { settings: {}, scopedSettings: {} };
var _allSettings = GlobalSettings_1.GlobalSettings.getValue(CustomizationsGlobalKey, {
...
var index_1 = __webpack_require__(46);
var fonts_1 = __webpack_require__(85);
var language_1 = __webpack_require__(86);
// Default urls.
...
Object.defineProperty(exports, "__esModule", { value: true });
var dom_1 = __webpack_require__(48);
var localStorage_1 = __webpack_require__(146);
...
var EventGroup_1 = __webpack_require__(56);
var warn_1 = __webpack_require__(60);
var initializeFocusRects_1 = __webpack_require__(91);
var initializeDir_1 = __webpack_require__(150);
/**
 * BaseComponent class, which provides basic helpers for all components.
 *
 * @public
...
"use strict";
/* unused harmony export DirectionalHint */
var DirectionalHint;
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Fabric/Fabric.styles.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Fabric/Fabric.js




var getClassNames = Object(Utilities["classNamesFunction"])();
var Fabric_Fabric = /** @class */ (function (_super) {
    tslib_es6["__extends"](Fabric, _super);
    function Fabric() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Fabric.prototype.render = function () {
        var classNames = getClassNames(Fabric_styles_getStyles, this.props);
        var divProps = Object(Utilities["getNativeProps"])(this.props, Utilities["divProperties"]);
        return (react["createElement"]("div", tslib_es6["__assign"]({}, divProps, { className: classNames.root })));
    };
    Fabric = tslib_es6["__decorate"]([
        Object(Utilities["customizable"])('Fabric', ['theme'])
    ], Fabric);
    return Fabric;
}(Utilities["BaseComponent"]));


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Fabric/index.js


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Fabric.js


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Layer/Layer.base.js
...
var Layer_base_getClassNames = Object(Utilities["classNamesFunction"])();
var Layer_base_LayerBase = /** @class */ (function (_super) {
    tslib_es6["__extends"](LayerBase, _super);
    function LayerBase(props) {
        var _this = _super.call(this, props) || this;
        _this._rootElement = Object(Utilities["createRef"])();
        _this._warnDeprecations({
    ...
    LayerBase.prototype.componentDidUpdate = function () {
        ...
        var _a = this.props, className = _a.className, getStyles = _a.getStyles, theme = _a.theme;
        var classNames = Layer_base_getClassNames(getStyles, {
            theme: theme,
            className: className,
        ...
        if (host) {
            ...
            if (!this._layerElement) {
                var rootElement = this._rootElement.value;
                var doc = Object(Utilities["getDocument"])(rootElement);
                if (!doc || !rootElement) {
                    return;
                }
                ...
                Object(Utilities["setVirtualParent"])(this._layerElement, rootElement);
            }
            // Using this 'unstable' method allows us to retain the React context across the layer projection.
            FakeReactDOM["unstable_renderSubtreeIntoContainer"](this, (react["createElement"](Fabric_Fabric, { className: classNames.content }, this.props.children)), this._layerElement, function () {
    ...
    LayerBase.prototype._removeLayerElement = function () {
        if (this._layerElement) {
            ...
            FakeReactDOM["unmountComponentAtNode"](this._layerElement);
    ...
    LayerBase.prototype._getHost = function () {
        ...
        var doc = Object(Utilities["getDocument"])(this._rootElement.value);
        if (!doc) {
            return undefined;
        }
        if (hostId) {
    ...
    LayerBase = tslib_es6["__decorate"]([
        Object(Utilities["customizable"])('Layer', ['theme', 'hostId'])
    ], LayerBase);
    return LayerBase;
}(Utilities["BaseComponent"]));


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Layer/Layer.styles.js
var Layer_styles_getStyles = function (props) {
    var className = props.className, isNotHost = props.isNotHost;
    return ({
        root: [
            'ms-Layer',
            isNotHost && [
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Layer/Layer.js



var Layer = Object(Utilities["styled"])(Layer_base_LayerBase, Layer_styles_getStyles);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Layer/LayerHost.js




var LayerHost_LayerHost = /** @class */ (function (_super) {
    tslib_es6["__extends"](LayerHost, _super);
    function LayerHost() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ...
    LayerHost.prototype.componentDidMount = function () {
        Layer_base_LayerBase.notifyHostChanged(this.props.id);
    };
    LayerHost.prototype.componentWillUnmount = function () {
        Layer_base_LayerBase.notifyHostChanged(this.props.id);
    };
    LayerHost.prototype.render = function () {
        return (react["createElement"]("div", tslib_es6["__assign"]({}, this.props, { className: Object(Utilities["css"])('ms-LayerHost', this.props.className) })));
    };
    return LayerHost;
}(Utilities["BaseComponent"]));


// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Layer/index.js




// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Layer.js
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tslib__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Utilities__ = __webpack_require__(43);


var BaseDecorator = /** @class */ (function (_super) {
    __WEBPACK_IMPORTED_MODULE_0_tslib__["__extends"](BaseDecorator, _super);
    ...
    BaseDecorator.prototype._updateComposedComponentRef = function (composedComponentInstance) {
        ...
        if (composedComponentInstance) {
            this._hoisted = Object(__WEBPACK_IMPORTED_MODULE_1__Utilities__["hoistMethods"])(this, composedComponentInstance);
        }
        else if (this._hoisted) {
            Object(__WEBPACK_IMPORTED_MODULE_1__Utilities__["unhoistMethods"])(this, this._hoisted);
        }
    };
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/utilities/positioning/positioning.types.js
var RectangleEdge;
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/utilities/positioning/positioning.js
...
var DirectionalDictionary = (positioning__a = {},
    positioning__a[0 /* topLeftEdge */] = _createPositionData(RectangleEdge.top, RectangleEdge.left),
    positioning__a[1 /* topCenter */] = _createPositionData(RectangleEdge.top),
    positioning__a[2 /* topRightEdge */] = _createPositionData(RectangleEdge.top, RectangleEdge.right),
    positioning__a[3 /* topAutoEdge */] = _createPositionData(RectangleEdge.top, undefined, true),
    positioning__a[4 /* bottomLeftEdge */] = _createPositionData(RectangleEdge.bottom, RectangleEdge.left),
    positioning__a[5 /* bottomCenter */] = _createPositionData(RectangleEdge.bottom),
    positioning__a[6 /* bottomRightEdge */] = _createPositionData(RectangleEdge.bottom, RectangleEdge.right),
    positioning__a[7 /* bottomAutoEdge */] = _createPositionData(RectangleEdge.bottom, undefined, true),
    positioning__a[8 /* leftTopEdge */] = _createPositionData(RectangleEdge.left, RectangleEdge.top),
    positioning__a[9 /* leftCenter */] = _createPositionData(RectangleEdge.left),
    positioning__a[10 /* leftBottomEdge */] = _createPositionData(RectangleEdge.left, RectangleEdge.bottom),
    positioning__a[11 /* rightTopEdge */] = _createPositionData(RectangleEdge.right, RectangleEdge.top),
    positioning__a[12 /* rightCenter */] = _createPositionData(RectangleEdge.right),
    positioning__a[13 /* rightBottomEdge */] = _createPositionData(RectangleEdge.right, RectangleEdge.bottom),
    positioning__a);
/**
 * @deprecated will be removed in 6.0.
 */
var SLIDE_ANIMATIONS = (_b = {},
    _b[RectangleEdge.top] = 'slideUpIn20',
    _b[RectangleEdge.bottom] = 'slideDownIn20',
    _b[RectangleEdge.left] = 'slideLeftIn20',
    _b[RectangleEdge.right] = 'slideRightIn20',
    _b);
/**
 * Do not call methods from this directly, use either positionCallout or positionElement or make another function that
 * utilizes them.
 */
var positioning_positioningFunctions;
(function (positioningFunctions) {
    ...
    function _getPositionData(directionalHint, directionalHintForRTL, previousPositions) {
        ...
        var positionInformation = tslib_es6["__assign"]({}, DirectionalDictionary[directionalHint]);
        if (Object(Utilities["getRTL"])()) {
    ...
    function _finalizeBeakPosition(elementPosition, positionedBeak) {
        ...
        return {
            elementPosition: tslib_es6["__assign"]({}, returnValue),
    ...
    positioningFunctions._getRectangleFromElement = _getRectangleFromElement;
    ...
    function _positionElementRelative(props, hostElement, elementToPosition, previousPositions) {
        ...
        var boundingRect = props.bounds ?
            ...
            new positioning_Rectangle(0, window.innerWidth - Object(Utilities["getScrollbarWidth"])(), 0, window.innerHeight);
        ...
        return tslib_es6["__assign"]({}, positionedElement, { targetRectangle: targetRect });
    }
    ...
    function _positionCallout(props, hostElement, callout, previousPositions) {
        ...
        return tslib_es6["__assign"]({}, _finalizePositionData(positionedElement, hostElement), { beakPosition: finalizedBeakPosition });
    }
    ...
    function _getRelativePositions(props, hostElement, elementToPosition) {
        ...
        return {
            ...
            beakPosition: { position: tslib_es6["__assign"]({}, beakPosition), display: 'block' },
            directionalClassName: SLIDE_ANIMATIONS[positions.targetEdge],
            submenuDirection: (positions.targetEdge * -1) === RectangleEdge.right ? 10 /* leftBottomEdge */ : 13 /* rightBottomEdge */
        };
    }
    positioningFunctions._getRelativePositions = _getRelativePositions;
})(positioning_positioningFunctions || (positioning_positioningFunctions = {}));
/**
 * @deprecated Do not use, this will be removed in 6.0.
...
function getRelativePositions(props, hostElement, calloutElement) {
    return positioning_positioningFunctions._getRelativePositions(props, hostElement, calloutElement);
}
/**
...
function positionElement(props, hostElement, elementToPosition, previousPositions) {
    return positioning_positioningFunctions._positionElement(props, hostElement, elementToPosition, previousPositions);
}
function positionCallout(props, hostElement, elementToPosition, previousPositions) {
    return positioning_positioningFunctions._positionCallout(props, hostElement, elementToPosition, previousPositions);
}
/**
...
function getMaxHeight(target, targetEdge, gapSpace, bounds) {
    ...
    var boundingRectangle = bounds ?
        positioning_positioningFunctions._getRectangleFromIRect(bounds) :
        new positioning_Rectangle(0, window.innerWidth - Object(Utilities["getScrollbarWidth"])(), 0, window.innerHeight);
    if (mouseTarget.stopPropagation) {
        ...
        targetRect = positioning_positioningFunctions._getRectangleFromElement(elementTarget);
    }
    return positioning_positioningFunctions._getMaxHeightFromTargetRectangle(targetRect, targetEdge, gapSpace, boundingRectangle);
}
var positioning__a, _b;

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/utilities/positioning/index.js



// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/utilities/positioning.js


// EXTERNAL MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Popup/index.js + 1 modules
var Popup = __webpack_require__(99);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Popup.js


// EXTERNAL MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Styling.js
var Styling = __webpack_require__(45);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Callout/CalloutContent.base.js
...
var ANIMATIONS = (CalloutContent_base__a = {},
    CalloutContent_base__a[RectangleEdge.top] = Styling["AnimationClassNames"].slideUpIn10,
    CalloutContent_base__a[RectangleEdge.bottom] = Styling["AnimationClassNames"].slideDownIn10,
    CalloutContent_base__a[RectangleEdge.left] = Styling["AnimationClassNames"].slideLeftIn10,
    CalloutContent_base__a[RectangleEdge.right] = Styling["AnimationClassNames"].slideRightIn10,
...
var CalloutContent_base_CalloutContentBase = /** @class */ (function (_super) {
    tslib_es6["__extends"](CalloutContentBase, _super);
    function CalloutContentBase(props) {
        var _this = _super.call(this, props) || this;
        _this._hostElement = Object(Utilities["createRef"])();
        _this._calloutElement = Object(Utilities["createRef"])();
        ...
        _this._setInitialFocus = function () {
            if (_this.props.setInitialFocus && !_this._didSetInitialFocus && _this.state.positions && _this._calloutElement.value) {
                _this._didSetInitialFocus = true;
                _this._async.requestAnimationFrame(function () { return Object(Utilities["focusFirstChild"])(_this._calloutElement.value); });
            }
        };
    ...
    CalloutContentBase.prototype.render = function () {
        ...
        var overflowStyle = overflowYHidden ? { overflowY: 'hidden', maxHeight: contentMaxHeight } : { maxHeight: contentMaxHeight };
        ...
        var content = (react["createElement"]("div", { ref: this._hostElement, className: this._classNames.container, style: visibilityStyle },
            react["createElement"]("div", { className: Object(Utilities["css"])(this._classNames.root, positions && positions.targetEdge && ANIMATIONS[positions.targetEdge]), style: positions ? positions.elementPosition : OFF_SCREEN_STYLE, tabIndex: -1, 
                ...
                !this.props.hidden && react["createElement"](Popup["a" /* Popup */], { role: role, ariaLabel: ariaLabel, ariaDescribedBy: ariaDescribedBy, ariaLabelledBy: ariaLabelledBy, className: this._classNames.calloutMain, onDismiss: this.dismiss, onScroll: onScroll, shouldRestoreFocus: true, style: overflowStyle }, children))));
        return content;
    };
    ...
    CalloutContentBase.prototype._dismissOnLostFocus = function (ev) {
        var target = ev.target;
        var clickedOutsideCallout = this._hostElement.value && !Object(Utilities["elementContains"])(this._hostElement.value, target);
        if ((!this._target && clickedOutsideCallout) ||
            ev.target !== this._targetWindow &&
                clickedOutsideCallout &&
                (this._target.stopPropagation ||
                    (!this._target || (target !== this._target && !Object(Utilities["elementContains"])(this._target, target))))) {
            this.dismiss(ev);
        }
    };
    ...
    CalloutContentBase.prototype._getBeakPosition = function () {
        var positions = this.state.positions;
        var beakPostionStyle = tslib_es6["__assign"]({}, (positions && positions.beakPosition ? positions.beakPosition.elementPosition : null));
    ...
    CalloutContentBase.prototype._updatePosition = function () {
        var positions = this.state.positions;
        var hostElement = this._hostElement.value;
        var calloutElement = this._calloutElement.value;
        if (hostElement && calloutElement) {
            var currentProps = void 0;
            currentProps = Object(Utilities["assign"])(currentProps, this.props);
        ...
        if (!this._maxHeight) {
            if (this.props.directionalHintFixed && this._target) {
                ...
                this._async.requestAnimationFrame(function () {
                    if (_this._target) {
                        _this._maxHeight = getMaxHeight(_this._target, _this.props.directionalHint, totalGap_1, _this._getBounds());
                        _this.forceUpdate();
                    }
                });
            }
    ...
    CalloutContentBase.prototype._setHeightOffsetEveryFrame = function () {
        ...
        if (this._calloutElement.value && this.props.finalHeight) {
            this._setHeightOffsetTimer = this._async.requestAnimationFrame(function () {
                var calloutMainElem = _this._calloutElement.value && _this._calloutElement.value.lastChild;
                if (!calloutMainElem) {
                    return;
                }
    ...
    CalloutContentBase = tslib_es6["__decorate"]([
        Object(Utilities["customizable"])('CalloutContent', ['theme'])
    ], CalloutContentBase);
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Callout/CalloutContent.styles.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Callout/CalloutContent.js



var CalloutContent = Object(Utilities["styled"])(CalloutContent_base_CalloutContentBase, CalloutContent_styles_getStyles);

// EXTERNAL MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Layer.js + 9 modules
var Layer = __webpack_require__(95);

// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Callout/Callout.js
...
var Callout_Callout = /** @class */ (function (_super) {
    tslib_es6["__extends"](Callout, _super);
    ...
    Callout.prototype.render = function () {
        var content = (react["createElement"](CalloutContent, tslib_es6["__assign"]({}, this.props)));
        return this.props.doNotLayer ? content : (react["createElement"](Layer["a" /* Layer */], null, content));
    };
    return Callout;
}(Utilities["BaseComponent"]));
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Callout/index.js



// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/Callout.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Popup/Popup.js
...
var Popup_Popup = /** @class */ (function (_super) {
    tslib_es6["__extends"](Popup, _super);
    ...
    Popup.prototype.componentWillMount = function () {
        this._originalFocusedElement = Object(Utilities["getDocument"])().activeElement;
    };
    Popup.prototype.componentDidMount = function () {
        ...
        if (Object(Utilities["doesElementContainFocus"])(this._root.value)) {
    ...
    Popup.prototype.render = function () {
        ...
        return (react["createElement"]("div", tslib_es6["__assign"]({ ref: this._root }, Object(Utilities["getNativeProps"])(this.props, Utilities["divProperties"]), { className: className, role: role, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, "aria-describedby": ariaDescribedBy, onKeyDown: this._onKeyDown, style: tslib_es6["__assign"]({ overflowY: this.state.needsVerticalScrollBar ? 'scroll' : 'auto' }, style) }), this.props.children));
    };
    ...
    Popup.prototype._getScrollBar = function () {
        ...
        if (this._root && this._root.value && this._root.value.firstElementChild) {
            ...
            // scroll bar.
            var rootHeight = this._root.value.clientHeight;
            var firstChildHeight = this._root.value.firstElementChild.clientHeight;
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.83.0/react-dom@15.6.2+react@15.6.2/node_modules/office-ui-fabric-react/lib-es2015/components/Popup/index.js
...
Object.defineProperty(exports, "__esModule", { value: true });
var EventGroup_1 = __webpack_require__(51);
var scroll_1 = __webpack_require__(67);
var dom_1 = __webpack_require__(47);
...
Object.defineProperty(exports, "__esModule", { value: true });
var styleToClassName_1 = __webpack_require__(52);
var extractStyleParts_1 = __webpack_require__(68);
/**
 * Concatination helper, which can merge class names together. Skips over falsey values.
 *
 * @public
...
Object.defineProperty(exports, "__esModule", { value: true });
var getVendorSettings_1 = __webpack_require__(105);
var autoPrefixNames = {
    'user-select': 1
};
...
var BaseComponent_1 = __webpack_require__(70);
/**
...
var React = __webpack_require__(16);
var PropTypes = __webpack_require__(53);
var Customizations_1 = __webpack_require__(73);
var hoistStatics_1 = __webpack_require__(79);
...
Object.defineProperty(exports, "__esModule", { value: true });
var dom_1 = __webpack_require__(47);
var localStorage_1 = __webpack_require__(130);
// Default to undefined so that we initialize on first read.
var _language;
/**
 * Gets the rtl state of the page (returns true if in rtl.)
...
Object.defineProperty(exports, "__esModule", { value: true });
var dom_1 = __webpack_require__(47);
var sessionStorage_1 = __webpack_require__(137);
var rtlifyRules_1 = __webpack_require__(58);
...
var FontClassNames_1 = __webpack_require__(180);
exports.FontClassNames = FontClassNames_1.FontClassNames;
var ColorClassNames_1 = __webpack_require__(181);
...
Object.defineProperty(exports, "__esModule", { value: true });
var MergeStyles_1 = __webpack_require__(82);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var CommonStyles_1 = __webpack_require__(87);
...
function getFocusStyle(theme, inset, position, highContrastStyle) {
    ...
    return {
        ...
        selectors: (_a = {
            ...
            _a["." + index_1.IsFocusVisibleClassName + " &:focus:after"] = {
                content: '""',
                position: 'absolute',
                left: inset + 1,
                top: inset + 1,
...
Object.defineProperty(exports, "__esModule", { value: true });
var EventGroup_1 = __webpack_require__(56);
var scroll_1 = __webpack_require__(89);
var dom_1 = __webpack_require__(48);
var SCROLL_ITERATION_DELAY = 16;
var SCROLL_GUTTER_HEIGHT = 100;
var MAX_SCROLL_VELOCITY = 15;
...
var React = __webpack_require__(16);
var PropTypes = __webpack_require__(53);
var BaseComponent_1 = __webpack_require__(90);
/**
 * The Customizer component allows for default props to be mixed into components which
 * are decorated with the customizable() decorator. This enables injection scenarios like:
 *
...
var React = __webpack_require__(16);
var PropTypes = __webpack_require__(53);
var Customizations_1 = __webpack_require__(63);
var hoistStatics_1 = __webpack_require__(92);
function customizable(scope, fields
// tslint:disable-next-line:no-any
) {
    // tslint:disable-next-line:no-shadowed-variable
...
Object.defineProperty(exports, "__esModule", { value: true });
var object_1 = __webpack_require__(93);
/**
 * An array of events that are allowed on every html element type.
 *
 * @public
...
Object.defineProperty(exports, "__esModule", { value: true });
var dom_1 = __webpack_require__(48);
var sessionStorage_1 = __webpack_require__(173);
var rtlifyRules_1 = __webpack_require__(58);
var RTL_LOCAL_STORAGE_KEY = 'isRTL';
// Default to undefined so that we initialize on first read.
var _isRTL;
...
var DefaultFontStyles_1 = __webpack_require__(84);
var DefaultPalette_1 = __webpack_require__(62);
var load_themed_styles_1 = __webpack_require__(40);
var _theme = {
...
// module
exports.push([module.i, ".dialogContainer_2af14d8f{min-width:500px!important;max-width:50vw}", ""]);
...
// module
exports.push([module.i, ".warningText_7e41b972{color:#e81123;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;cursor:default}.calloutFadeIn_7e41b972{opacity:1!important;transform:ms-translate3d(0,0,0)!important}div .callout_7e41b972{max-width:200px;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;cursor:default;opacity:0;transform:ms-translate3d(0,20px,0);transition:opacity .2s,transform .2s;animation:none}.calloutText_7e41b972{padding:18px 24px 12px;margin:0;font-size:21px;font-weight:100;color:#333;font-weight:300}", ""]);
...
// module
exports.push([module.i, ".detailText_fececa01{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;cursor:default}.errorText_fececa01{font-family:monospace;-webkit-user-select:text;-moz-user-select:text;-ms-user-select:text;user-select:text}", ""]);
...
//# sourceMappingURL=1.1_94758b2c4434ddb2f367.js.map