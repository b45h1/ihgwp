webpackJsonp8be81a5c_af38_4bb2_af97_afa3b64dfbed_1_5_0([3],{
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-dragzone/lib/DragZoneUtilities.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-dragzone/lib/DragZoneTree.js
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-dragzone/lib/DragZoneKeyboard.js
...
var DragZoneKeyboard_DragZoneKeyboard = (function () {
    ...
    DragZoneKeyboard.prototype._viewModeKeyDown = function (evt) {
        ...
        if (!this._isMoving && (evt.keyCode === KeyCodes.Enter || evt.keyCode === KeyCodes.Space)) {
            this._isMoving = true;
            sp_a11y_lib["ScreenReader"].alert(DRAG_ZONE, strings.moveStarted);
            ...
            sp_a11y_lib["ScreenReader"].alert(DRAG_ZONE, strings.moveCancelled);
    ...
    DragZoneKeyboard.prototype._moveModeKeyDown = function (evt) {
        ...
        if (evt.keyCode === KeyCodes.Enter) {
            ...
            if (tree.isDragAllowed(this._draggedElement, this._dropOverElement, disallowedTag)) {
                ...
                sp_a11y_lib["ScreenReader"].alert(DRAG_ZONE, lib["StringHelper"].format(strings.moveComplete, this._formatFullPosition(this._draggedPosition), this._formatFullPosition(this._dropPosition)));
                this._setFocusOnHandle(draggedElement);
            }
            else {
                sp_a11y_lib["ScreenReader"].alert(DRAG_ZONE, strings.moveNotAllowed);
            }
            this._isMoving = false;
    ...
    DragZoneKeyboard.prototype._moveForward = function () {
        ...
        if (this._currentLocationIndex < this._treeMatrix.length - 1) {
            ...
            if (!tree.isLeafElement(newTentativeElement)) {
                ...
                sp_a11y_lib["ScreenReader"].alert(DRAG_ZONE, this._formatFullPosition(this._dropPosition));
            }
            else {
                if (this._indexNotChanged) {
                    ...
                    this._currentLocationIndex++;
                    sp_a11y_lib["ScreenReader"].alert(DRAG_ZONE, this._formatPosition(this._dropPosition));
                }
...
// CONCATENATED MODULE: C:/agent/1/_work/7/s/libraries/sp-dragzone/lib/DragZoneControl.js
...
//# sourceMappingURL=3.3_3d37e24290a78cfa0752.js.map