define([], function() {
  var strings = {
    ...
    "_yMeGkKybrchrRl4dKHORJw": {
      ...
      "FormattingBarBoldButtonTitle": "Bold (Ctrl+B)",
      ...
      "ImagesWithTextNotSupported": "Can't paste image within text, table, list or multiple images at once. Please paste each image\r\n    individually.",
      "ImagesInTableNotSupported": "***Can't paste image inside table. Inline images are not supported.",
    ...
    "_/GZrHjuQO4erDQbBRI2XSA": {
      ...
      "SearchTextFieldPlaceholder": "Enter keywords to search for pages on this site",
    ...
    "_WVn4QXYnL8WpGCqr2C9ySA": {
      ...
      "LargeToolboxAriaSubTitle": "There are {0} items in the toolbox.||There are {0} item in the toolbox.||There are {0} items in the toolbox.",
    ...
    "_CZsUWMvZilAKKAfwQSdzKQ": {
      ...
      "ToolboxSectionHeader": "Section layout",
      "CanvasItems": "{0} web parts displayed in the toolbox.||{0} web part displayed in the toolbox.||{0} web parts displayed in the toolbox.",
      "CanvasItemsInterval": "0||1||2-"
    },
