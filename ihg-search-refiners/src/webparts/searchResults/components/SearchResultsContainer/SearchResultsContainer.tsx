...
export default class SearchResultsContainer extends React.Component<ISearchContainerProps, ISearchContainerState> {
    ...
    public render(): React.ReactElement<ISearchContainerProps> {
        ...
        if (isComponentLoading) {
            ...
            if (hasError) {
                ...
                if (items.RelevantResults.length === 0) {
                    wpContent =
                        <div>
                            <FilterPanel availableFilters={this.state.availableFilters} onUpdateFilters={this._onUpdateFilters} showFilter={this.props.showFilter} />
                    ...
                    wpContent =
                        ...
                        <div>
                            <FilterPanel availableFilters={this.state.availableFilters} onUpdateFilters={this._onUpdateFilters} showFilter={this.props.showFilter} />
                            {renderOverlay}
                            <TilesList items={items.RelevantResults} layoutMode={this.props.layoutMode} showFileIcon={this.props.showFileIcon} showCreatedDate={this.props.showCreatedDate} />
        ...
        return (
            ...
            <div className="searWpTitle ms-font-xxl">{this.props.wpTitle}</div>
                {wpContent}
            </div>
        );
    }
