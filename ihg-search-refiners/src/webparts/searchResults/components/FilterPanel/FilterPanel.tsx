    ...
    public render(): React.ReactElement<IFilterPanelProps> {
        ...
        return (
            <div>
                ...
                {(this.state.selectedFilters.length > 0 && this.props.showFilter==true) ?
...
export function showConsoleText(){
    console.log("Importing this function");
    
}
// export function _clearFilters() {
//     // this._applyFilters([]);
//     // this._applyAllfilters([]);
//     this.default._applyFilters([]);
// }